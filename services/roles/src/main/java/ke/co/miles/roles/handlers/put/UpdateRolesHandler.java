...
public class UpdateRolesHandler {
	...
	/**
	 * Updates roles records
	 * @param request the request containing the details of the roles records to be updated
	 * @return the response containing the details of the newly updated roles records
	 */
