...
@Component
@Slf4j
public class CreateRolesHandler {
	...
	/**
	 * Recursively creates roles records
	 *
	 * @param request the request containing the details of the roles records to be created
	 * @return the stream of responses containing the details of the newly created roles records
	 */
	public Mono<ServerResponse> createRoles(ServerRequest request) {

		log.trace("Entering createRoles()");
