...
@ContextConfiguration(initializers = UpdateDataFormIT.Initializer.class)
public class UpdateDataFormIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(dataForm1), DataForm.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(dataForm1.getVersion() + 1);
            }
        );
  }
