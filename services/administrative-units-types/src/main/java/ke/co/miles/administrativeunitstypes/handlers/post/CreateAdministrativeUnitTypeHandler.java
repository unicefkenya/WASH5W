 ...
 */
package ke.co.miles.administrativeunitstypes.handlers.post;
...
@Component
@Slf4j
public class CreateAdministrativeUnitTypeHandler {

  @Autowired
  AdministrativeUnitsTypesRepository repository;

  /**
   * Creates a administrativeUnitType record
   *
   * @param request the request containing the details of the administrativeUnitType record to be created and the
   *                database within which it should be created
   * @return the response containing the details of the newly created administrativeUnitType record
   */
  public Mono<ServerResponse> createAdministrativeUnitType(ServerRequest request) {

    log.trace("Entering createAdministrativeUnitType()");
    ...
    return
        ServerResponse
            ...
            .body(
                request
                    ...
                    .flatMap(administrativeUnitType ->
                        repository
                            .insertAdministrativeUnitType(administrativeUnitType)
                            .map(id ->
            ...
            .onErrorMap(e -> new ServerException("AdministrativeUnitType creation failed", e));
  }
