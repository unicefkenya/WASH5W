...
@ContextConfiguration(initializers = UpdateAdministrativeUnitTypeIT.Initializer.class)
public class UpdateAdministrativeUnitTypeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/administrative_units_types/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(administrativeUnitType1), AdministrativeUnitType.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(administrativeUnitType1.getVersion() + 1);
            }
        );
  }
