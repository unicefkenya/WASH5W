 ...
 */
package ke.co.miles.logicalhierarchies.repository.updation;
...
@Component
@Slf4j
public class UpdateLogicalHierarchyQuery {
   ...
   * @return the number of logicalHierarchies records affected by the query i.e. updated
   */
  public Mono<Integer> updateLogicalHierarchy(LogicalHierarchy logicalHierarchy) {

    log.trace("Entering updateLogicalHierarchy()");

    String query = "UPDATE logical_hierarchy SET data = ?::jsonb WHERE id = ?";
