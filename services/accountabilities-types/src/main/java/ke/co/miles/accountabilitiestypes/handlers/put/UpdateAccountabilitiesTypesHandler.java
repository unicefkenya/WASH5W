...
@Component
@Slf4j
public class UpdateAccountabilitiesTypesHandler {

  @Autowired
  AccountabilitiesTypesRepository repository;

  /**
   * Updates accountabilities types records
   *
   * @param request the request containing the details of the accountabilities types records to be
   *                updated
   * @return the response containing the details of the newly updated accountabilities types records
   */
