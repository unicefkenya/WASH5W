...
@ContextConfiguration(initializers = CreateAccountabilitiesTypesIT.Initializer.class)
public class CreateAccountabilitiesTypesIT {
  ...
  static final AccountabilityType accountabilityType7;
  ...
  static {
    ...
    accountabilityType7 =
        new AccountabilityTypeBuilder()
            .id(null)
            .data(
                "{\"hierarchy\": {\"id\": 7}, \"commissioner\": {\"id\": 70, \"name\": \"Seventieth\"}, \"responsible\": {\"id\": 700, \"name\": \"Seven Hundredth\"}}")
            .version(null)
            .build();
  }
  ...
  public void Given_AccountabilityTypeDetailsList_When_PostAll_Then_AccountabilityTypeRecordsWillBeCreatedAndReturned() {
    ...
    webTestClient
        ...
        .body(Flux.fromIterable(Arrays.asList(accountabilityType6, accountabilityType7)),
        ...
        .value(response -> {
          ...
          MatcherAssert.assertThat(response.get(0).getData(),
              Matchers.either(Matchers.is(accountabilityType6.getData()))
                  .or(Matchers.is(accountabilityType7.getData())));
