...
@ContextConfiguration(initializers = UpdateDissagregationSchemeIT.Initializer.class)
public class UpdateDissagregationSchemeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/dissagregations_schemes/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(dissagregationScheme1), DissagregationScheme.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(dissagregationScheme1.getVersion() + 1);
            }
        );
  }
