...
@ContextConfiguration(initializers = UpdateDataFormElementIT.Initializer.class)
public class UpdateDataFormElementIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(dataFormElement1), DataFormElement.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(dataFormElement1.getVersion() + 1);
            }
        );
  }
