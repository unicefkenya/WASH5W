 ...
 */
package ke.co.miles.workflows.handlers.delete;
...
public class DeleteWorkflowHandler {
   ...
   *
   * @param request the request containing the details of the workflow record to be deleted and the
   *                database from which it should be deleted
   * @return the response containing the number of workflows records deleted
   */
  public Mono<ServerResponse> deleteWorkflow(ServerRequest request) {

    log.trace("Entering deleteWorkflow()");
    ...
    return
        ServerResponse
            ...
            .body(
                repository
                    .deleteWorkflowById(Long.parseLong(request.pathVariable("id"))),
                Integer.class)
