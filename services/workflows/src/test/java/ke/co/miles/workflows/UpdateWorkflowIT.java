...
@ContextConfiguration(initializers = UpdateWorkflowIT.Initializer.class)
public class UpdateWorkflowIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/workflows/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(workflow1), Workflow.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(workflow1.getVersion() + 1);
            }
        );
  }
