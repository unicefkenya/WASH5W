...
@ContextConfiguration(initializers = UpdateEntityIT.Initializer.class)
public class UpdateEntityIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(entity1), Entity.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(entity1.getVersion() + 1);
            }
        );
  }
