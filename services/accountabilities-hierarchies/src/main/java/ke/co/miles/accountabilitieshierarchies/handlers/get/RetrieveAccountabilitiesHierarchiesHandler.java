 ...
 */
package ke.co.miles.accountabilitieshierarchies.handlers.get;
...
@Component
@Slf4j
public class RetrieveAccountabilitiesHierarchiesHandler {

    @Autowired
    AccountabilitiesHierarchiesRepository repository;

    /**
     * Retrieves all AccountabilitiesHierarchies or specific AccountabilitiesHierarchies if given their unique identifiers
     *
     * @param request the request, optionally containing the query filters of the accountabilities hierarchies records to be retrieved
     *                and the database from which they should be retrieved
     *
     * @return the stream of responses containing the details of the retrieved accountabilities hierarchies records
     */
    public Mono<ServerResponse> retrieveAccountabilitiesHierarchies(ServerRequest request) {

        log.trace("Entering retrieveAccountabilitiesHierarchies()");
        ...
        return
                ServerResponse
                        ...
                        .body(
                                repository
                                        .selectAccountabilitiesHierarchies(
