...
@Component
@Slf4j
public class DeleteAccountabilityHierarchyHandler {

    @Autowired
    AccountabilitiesHierarchiesRepository repository;

    /**
     * Deletes an accountability hierarchy record
     *
     * @param request the request containing the details of the accountability hierarchy record to be deleted and the database from
    ...
    public Mono<ServerResponse> deleteAccountabilityHierarchy(ServerRequest request) {
        ...
        return
                ServerResponse
                        ...
                        .body(
                                repository
                                        .deleteAccountabilityHierarchyById(
