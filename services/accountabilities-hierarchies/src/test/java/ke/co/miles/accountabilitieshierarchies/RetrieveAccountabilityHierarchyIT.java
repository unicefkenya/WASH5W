...
@ContextConfiguration(initializers = RetrieveAccountabilityHierarchyIT.Initializer.class)
public class RetrieveAccountabilityHierarchyIT {
    ...
    @Test
    public void Given_AccountabilityHierarchyRecordExists_When_GetWithIdParameter_Then_TheAccountabilityHierarchyRecordWithThatIdWillBeReturned() {

        webTestClient
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/api/v1/accountabilities_hierarchies/test/ids/{id}")
                                .build(Long.toString(accountabilityHierarchy1.getId())))
                .exchange()
                .expectStatus().isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(accountabilityHierarchy1.getVersion());
                        }
                );
    }
}
