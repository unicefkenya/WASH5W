...
@ContextConfiguration(initializers = UpdateOrganisationTypeIT.Initializer.class)
public class UpdateOrganisationTypeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/organisations_types/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(organisationType1), OrganisationType.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(organisationType1.getVersion() + 1);
            }
        );
  }
