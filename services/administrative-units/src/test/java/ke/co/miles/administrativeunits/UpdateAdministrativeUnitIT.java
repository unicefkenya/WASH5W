...
@ContextConfiguration(initializers = UpdateAdministrativeUnitIT.Initializer.class)
public class UpdateAdministrativeUnitIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/administrative_units/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(administrativeUnit1), AdministrativeUnit.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(administrativeUnit1.getVersion() + 1);
            }
        );
  }
