...
@ContextConfiguration(initializers = UpdateSystemModulePermissionIT.Initializer.class)
public class UpdateSystemModulePermissionIT {
  ...
  static {
    ...
    systemModulePermission1 =
        new SystemModulePermissionBuilder()
            .id(1L)
            .data(
                "{\"systemModuleId\":1,\"code\":\"firstSystemModulePermissionCode\",\"name\":\"FIRST System Module Permission Name\",\"description\":\"First System Module Permission Description\",\"custom\":false}")
            .version(1)
            .build();
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/systems_modules_permissions/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(systemModulePermission1), SystemModulePermission.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(systemModulePermission1.getVersion() + 1);
            }
        );
  }
