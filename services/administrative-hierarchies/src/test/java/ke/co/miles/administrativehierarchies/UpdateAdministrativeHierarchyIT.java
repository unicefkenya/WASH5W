...
@ContextConfiguration(initializers = UpdateAdministrativeHierarchyIT.Initializer.class)
public class UpdateAdministrativeHierarchyIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/administrative_hierarchies/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(administrativeHierarchy1), AdministrativeHierarchy.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(administrativeHierarchy1.getVersion() + 1);
            }
        );
  }
