 ...
 */
package ke.co.miles.administrativehierarchies.repository.updation;
...
@Component
@Slf4j
public class UpdateAdministrativeHierarchyQuery {
   ...
   * @return the number of administrativeHierarchies records affected by the query i.e. updated
   */
  public Mono<Integer> updateAdministrativeHierarchy(AdministrativeHierarchy administrativeHierarchy) {
    ...
    String query = "UPDATE administrative_hierarchy SET data = ?::jsonb WHERE id = ?";
