...
public class CreateAttributeHandler {
     ...
     *
     * @param request the request containing the details of the attribute record to be created and the
     *                database within which it should be created
     * @return the response containing the details of the newly created attribute record
     */
    public Mono<ServerResponse> createAttribute(ServerRequest request) {

        log.trace("Entering createAttribute()");
