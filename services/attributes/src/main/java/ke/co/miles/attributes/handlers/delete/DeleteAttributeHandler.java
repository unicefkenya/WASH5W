...
@Component
@Slf4j
public class DeleteAttributeHandler {

    @Autowired
    AttributesRepository repository;

    /**
     * Deletes an attribute record
     *
     * @param request the request containing the details of the attribute record to be deleted and the database from
