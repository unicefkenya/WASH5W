...
-- ------------------------------------------------------------
CREATE OR REPLACE FUNCTION initializeAttributeVersion()
RETURNS "trigger" AS '
BEGIN
  New.version:=1;
  RETURN NEW;
...
CREATE TRIGGER initializeAttributeVersionTrigger
BEFORE INSERT
ON attribute
FOR EACH ROW
EXECUTE PROCEDURE initializeAttributeVersion();
...
CREATE OR REPLACE FUNCTION incrementAttributeVersion()
RETURNS "trigger" AS
'
BEGIN
...
CREATE TRIGGER incrementAttributeVersionTrigger
BEFORE UPDATE
ON attribute
FOR EACH ROW
EXECUTE PROCEDURE incrementAttributeVersion();
...
INSERT INTO attribute(data) VALUES('{"index": 1, "name": "First Attribute", "valid": true}');
INSERT INTO attribute(data) VALUES('{"index": 2, "name": "Second Attribute", "valid": true}');
INSERT INTO attribute(data) VALUES('{"index": 3, "name": "Third Attribute", "valid": false}');