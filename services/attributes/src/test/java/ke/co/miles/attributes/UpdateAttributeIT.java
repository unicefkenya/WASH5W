...
@ContextConfiguration(initializers = UpdateAttributeIT.Initializer.class)
public class UpdateAttributeIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Mono.just(attribute1), Attribute.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(attribute1.getVersion() + 1);
                        }
                );
    }
}
