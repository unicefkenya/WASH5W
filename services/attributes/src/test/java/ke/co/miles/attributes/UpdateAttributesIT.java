...
@ContextConfiguration(initializers = UpdateAttributesIT.Initializer.class)
public class UpdateAttributesIT {
    ...
    public void Given_ModifiedDetailsOfExistingRecords_When_PutAll_Then_TheRecordsWillBeUpdatedAndReturnedWithTheirVersionsIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Flux.fromIterable(Arrays.asList(attribute1, attribute2)), Attribute.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.get(0).getVersion()).isEqualTo(attribute1.getVersion() + 1);
                            ...
                            Assertions.assertThat(response.get(1).getVersion()).isEqualTo(attribute2.getVersion() + 1);
