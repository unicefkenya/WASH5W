...
@ContextConfiguration(initializers = UpdateContextIT.Initializer.class)
public class UpdateContextIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/contexts/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(context1), Context.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(context1.getVersion() + 1);
            }
        );
  }
