 ...
 */
package ke.co.miles.contexts.configurations;
...
import ke.co.miles.contexts.handlers.ContextsHandler;
...
public class RoutesConfig {
  ...
  @Bean
  RouterFunction<ServerResponse> routeRequests(ContextsHandler handler) {
        ...
        route()
            .POST("/api/v1/contexts",
                ...
                ops -> ops
                    ...
                    .beanClass(ContextsHandler.class)
                    .beanMethod("createContext")
                    .description("Creates a context record")
                    .requestBody(
                        requestBodyBuilder()
                    ...
                    .response(
                        responseBuilder()
                            .responseCode("201")
                            .description("The context record was successfully created")
                            .implementation(Context.class))
                    .response(
                        responseBuilder()
                            .responseCode("500").description(
                                "An unexpected condition was encountered while creating the context record")
            ...
            .and(route()
                .GET("/api/v1/contexts",
                    ...
                    handler::retrieveContexts,
                    ops -> ops
                        .tag("Retrieve")
                        .operationId("retrieveContexts")
                        .beanClass(ContextsHandler.class)
                        .beanMethod("retrieveContexts")
                        .description("Retrieves contexts records")
                        .parameter(
                            parameterBuilder()
                        ...
                        .parameter(
                            parameterBuilder()
                                ...
                                .description(
                                    "Restrict the records retrieved to the ones whose abbreviation is equal to this value")
                                .implementation(Integer.class))
                        .parameter(
                            parameterBuilder()
                                .name("abbreviation_like").in(ParameterIn.QUERY)
                                .description(
                                    "Restrict the records retrieved to the ones whose abbreviation contain this value fragment")
                                .implementation(Integer.class))
                        .parameter(
                            parameterBuilder()
                                .name("timestep.id").in(ParameterIn.QUERY)
                                .description(
                        ...
                        .response(
                            responseBuilder()
                                .responseCode("200").description(
                                    "The contexts records were successfully retrieved")
                                .implementationArray(Context.class))
                        .response(
                            responseBuilder()
                                .responseCode("500").description(
                                    "An unexpected condition was encountered while retrieving the contexts records")
                                .implementation(String.class)))
                .build())
            .and(route()
                .GET("/api/v1/contexts/{id}",
                    ...
                    ops -> ops
                        ...
                        .beanClass(ContextsHandler.class)
                        .beanMethod("retrieveContext")
                        .description("Retrieves a context record")
                        .parameter(
                            parameterBuilder()
                        ...
                        .response(
                            responseBuilder()
                                .responseCode("200")
                                .description("The context record was successfully retrieved")
                                .implementation(Context.class))
                        .response(
                            responseBuilder()
                                .responseCode("500").description(
                                    "An unexpected condition was encountered while retrieving the context record")
                                .implementation(String.class)))
                .build())
            ...
            .and(route()
                .PUT("/api/v1/contexts/{id}",
                    ...
                    ops -> ops
                        ...
                        .beanClass(ContextsHandler.class)
                        .beanMethod("updateContext")
                        .description("Updates a context record")
                        .parameter(
                            parameterBuilder()
                                .name("id").in(ParameterIn.PATH)
                                .description(
                        ...
                        .response(
                            responseBuilder()
                                .responseCode("200")
                                .description("The context record was successfully updated")
                                .implementation(Context.class))
                        .response(
                            responseBuilder()
                                .responseCode("500").description(
                                    "An unexpected condition was encountered while updating the context record")
                                .implementation(String.class)))
                .build())
                ...
                .DELETE("/api/v1/contexts/{id}",
                    ...
                    ops -> ops
                        ...
                        .response(
                            responseBuilder()
                                .responseCode("200")
                                .description("The context record was successfully deleted")
                                .implementation(Integer.class)
                                .description(
                                    "The number of contexts records successfully deleted"))
                        .response(
                            responseBuilder()
                                .responseCode("500").description(
                                    "An unexpected condition was encountered while deleting the context record")
                                .implementation(String.class)))
                .build());
  }
