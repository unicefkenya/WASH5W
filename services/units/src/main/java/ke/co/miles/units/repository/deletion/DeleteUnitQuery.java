 ...
 */
package ke.co.miles.units.repository.deletion;
...
public class DeleteUnitQuery {
   ...
   * @return the number of units records affected by the query i.e. deleted
   */
  public Mono<Integer> deleteUnit(Long id) {
