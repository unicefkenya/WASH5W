...
import ke.co.miles.units.daos.Metadata;
...
public class RetrieveUnitsHandler {
  ...
  /**
   * Retrieves units records
   *
   * @param request the request, optionally containing the query filters of the units
   *                records to be retrieved and the database from which they should be retrieved
   * @return the stream of responses containing the details of the retrieved units records
   */
  public Mono<ServerResponse> retrieveUnits(ServerRequest request) {
    ...
    return
        repository
            .selectTotalUnits(request.queryParams())
