...
@Component
@Slf4j
public class UpdateGroupsHandler {

	@Autowired
    GroupsRepository repository;
	
	/**
	 * Updates groups records
	 * @param request the request containing the details of the groups records to be updated
	 * @return the response containing the details of the newly updated groups records
	 */
