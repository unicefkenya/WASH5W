 ...
 */
package ke.co.miles.groups.handlers.delete;
...
@Component
@Slf4j
public class DeleteGroupsHandler {

    @Autowired
    GroupsRepository repository;

    /**
     * Deletes all Groups or specific groups records if given their unique identifiers
     *
     * @param request the request, optionally containing the unique identifiers of the groups records to be deleted
     *               and the database from which they should be deleted
     *
     * @return the response containing the number of groups records deleted
     */
