 ...
 */
package ke.co.miles.options.handlers.put;
...
public class UpdateOptionHandler {
   ...
   *
   * @param request the request containing the details of the option record to be updated
   * @return the response containing the details of the newly updated option record
   */
                        ...
                        repository
                            ...
                            .map(count ->
                                new OptionBuilder()
                                    ...
                                    .build())),
                Option.class)
            .onErrorMap(e -> new ServerException("Option update failed", e));
