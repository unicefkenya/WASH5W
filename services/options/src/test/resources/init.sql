...
-- ------------------------------------------------------------
CREATE OR REPLACE FUNCTION initializeOptionVersion()
RETURNS "trigger" AS '
BEGIN
  New.version:=1;
  RETURN NEW;
...
CREATE TRIGGER initializeOptionVersionTrigger
BEFORE INSERT
ON option
FOR EACH ROW
EXECUTE PROCEDURE initializeOptionVersion();
...
CREATE OR REPLACE FUNCTION incrementOptionVersion()
RETURNS "trigger" AS
'
BEGIN
...
CREATE TRIGGER incrementOptionVersionTrigger
BEFORE UPDATE
ON option
FOR EACH ROW
EXECUTE PROCEDURE incrementOptionVersion();
...
INSERT INTO option(data) VALUES('{"typeId":"1","name":"First Name"}');
INSERT INTO option(data) VALUES('{"typeId":"2","name":"Second Name"}');
INSERT INTO option(data) VALUES('{"typeId":"3","name":"Third Name"}');