...
@ContextConfiguration(initializers = UpdateOptionTypeIT.Initializer.class)
public class UpdateOptionTypeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(optionType1), OptionType.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(optionType1.getVersion() + 1);
            }
        );
  }
