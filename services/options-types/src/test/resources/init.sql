...
-- ------------------------------------------------------------
CREATE OR REPLACE FUNCTION initializeOptionTypeVersion()
RETURNS "trigger" AS '
BEGIN
  New.version:=1;
  RETURN NEW;
...
CREATE TRIGGER initializeOptionTypeVersionTrigger
BEFORE INSERT
ON option_type
FOR EACH ROW
EXECUTE PROCEDURE initializeOptionTypeVersion();
...
CREATE OR REPLACE FUNCTION incrementOptionTypeVersion()
RETURNS "trigger" AS
'
BEGIN
...
CREATE TRIGGER incrementOptionTypeVersionTrigger
BEFORE UPDATE
ON option_type
FOR EACH ROW
EXECUTE PROCEDURE incrementOptionTypeVersion();
...
INSERT INTO option_type(data) VALUES('{"name":"First Option Type Name"}');
INSERT INTO option_type(data) VALUES('{"name":"Second Option Type Name"}');
INSERT INTO option_type(data) VALUES('{"name":"Third Option Type Name"}');