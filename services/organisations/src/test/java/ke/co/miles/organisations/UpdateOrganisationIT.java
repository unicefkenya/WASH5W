...
@ContextConfiguration(initializers = UpdateOrganisationIT.Initializer.class)
public class UpdateOrganisationIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/organisations/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(organisation1), Organisation.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(organisation1.getVersion() + 1);
            }
        );
  }
