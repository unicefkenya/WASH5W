 ...
 */
package ke.co.miles.systemsusers.handlers.post;
...
@Component
@Slf4j
public class CreateSystemUserHandler {

  @Autowired
  SystemsUsersRepository repository;

  /**
   * Creates a systemUser record
   *
   * @param request the request containing the details of the systemUser record to be created and the
   *                database within which it should be created
   * @return the response containing the details of the newly created systemUser record
   */
  public Mono<ServerResponse> createSystemUser(ServerRequest request) {

    log.trace("Entering createSystemUser()");
                        ...
                        repository
                            ...
                            .map(id ->
                                new SystemUserBuilder()
                                    ...
                                    .build())),
                SystemUser.class)
            .onErrorMap(e -> new ServerException("SystemUser creation failed", e));
  }
