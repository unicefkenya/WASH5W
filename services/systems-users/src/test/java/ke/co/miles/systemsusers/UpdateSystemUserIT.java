...
@ContextConfiguration(initializers = UpdateSystemUserIT.Initializer.class)
public class UpdateSystemUserIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(systemUser1), SystemUser.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(systemUser1.getVersion() + 1);
            }
        );
  }
