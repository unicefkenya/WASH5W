...
import ke.co.miles.operators.util.builders.QueryPaginationClauseBuilder;
...
@Component
@Slf4j
public class SelectOperatorsQuery {

  @Autowired
  DatabaseConfig databaseConfig;

  /**
   * Selects all or specific operators records from the database depending on whether query
   * parameters were supplied as part of the query
   *
   * @param parameters the query parameters passed along with the request
   * @return a list of operators records if found
   */
  public Flux<Operator> selectOperators(MultiValueMap<String, String> parameters) {

    log.trace("Entering selectOperators()");
