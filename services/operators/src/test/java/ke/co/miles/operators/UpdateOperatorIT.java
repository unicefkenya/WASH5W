...
@ContextConfiguration(initializers = UpdateOperatorIT.Initializer.class)
public class UpdateOperatorIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        ...
        .body(Mono.just(operator1), Operator.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(operator1.getVersion() + 1);
            }
        );
  }
