 ...
 */
package ke.co.miles.dataformselementstypes.handlers.post;
...
@Component
@Slf4j
public class CreateDataFormElementTypeHandler {

  @Autowired
  DataFormsElementsTypesRepository repository;

  /**
   * Creates a dataFormElementType record
   *
   * @param request the request containing the details of the dataFormElementType record to be created and the
   *                database within which it should be created
   * @return the response containing the details of the newly created dataFormElementType record
   */
  public Mono<ServerResponse> createDataFormElementType(ServerRequest request) {

    log.trace("Entering createDataFormElementType()");
    ...
    return
        ServerResponse
            ...
            .body(
                request
                    ...
                    .flatMap(dataFormElementType ->
                        repository
                            .insertDataFormElementType(dataFormElementType)
                            .map(id ->
            ...
            .onErrorMap(e -> new ServerException("DataFormElementType creation failed", e));
  }
