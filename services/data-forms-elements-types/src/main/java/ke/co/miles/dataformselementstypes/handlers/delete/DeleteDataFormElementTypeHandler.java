 ...
 */
package ke.co.miles.dataformselementstypes.handlers.delete;
...
@Component
@Slf4j
public class DeleteDataFormElementTypeHandler {
   ...
   *
   * @param request the request containing the details of the dataFormElementType record to be deleted and the
   *                database from which it should be deleted
   * @return the response containing the number of dataFormsElementsTypes records deleted
   */
  public Mono<ServerResponse> deleteDataFormElementType(ServerRequest request) {
    ...
    return
        ServerResponse
            ...
            .body(
                repository
                    .deleteDataFormElementTypeById(Long.parseLong(request.pathVariable("id"))),
                Integer.class)
