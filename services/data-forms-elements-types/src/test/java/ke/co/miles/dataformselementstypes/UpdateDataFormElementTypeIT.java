...
@ContextConfiguration(initializers = UpdateDataFormElementTypeIT.Initializer.class)
public class UpdateDataFormElementTypeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/data_forms_elements_types/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(dataFormElementType1), DataFormElementType.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(dataFormElementType1.getVersion() + 1);
            }
        );
  }
