...
@ContextConfiguration(initializers = UpdateTypesIT.Initializer.class)
public class UpdateTypesIT {
    ...
    public void Given_ModifiedDetailsOfExistingRecords_When_PutAll_Then_TheRecordsWillBeUpdatedAndReturnedWithTheirVersionsIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Flux.fromIterable(Arrays.asList(type1, type2)), Type.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.get(0).getVersion()).isEqualTo(type1.getVersion() + 1);
                            ...
                            Assertions.assertThat(response.get(1).getVersion()).isEqualTo(type2.getVersion() + 1);
