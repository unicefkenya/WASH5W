...
public class UpdateTypesHandler {
	...
	/**
	 * Updates types records
	 * @param request the request containing the details of the types records to be updated
	 * @return the response containing the details of the newly updated types records
	 */
