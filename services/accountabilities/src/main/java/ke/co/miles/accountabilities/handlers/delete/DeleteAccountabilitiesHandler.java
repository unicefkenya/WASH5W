 ...
 */
package ke.co.miles.accountabilities.handlers.delete;
...
public class DeleteAccountabilitiesHandler {
  ...
  /**
   * Deletes all Accountabilities or specific accountabilities records if given their
   * unique identifiers
   *
   * @param request the request, optionally containing the unique identifiers of the
   *                accountabilities records to be deleted and the database from which they
   *                should be deleted
