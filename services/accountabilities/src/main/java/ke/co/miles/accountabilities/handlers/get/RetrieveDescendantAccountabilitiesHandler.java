...
@Component
@Slf4j
public class RetrieveDescendantAccountabilitiesHandler {

  @Autowired
  AccountabilitiesRepository repository;

  /**
   * Retrieves accountabilities descendant records from the database depending on whether path
  ...
  public Mono<ServerResponse> retrieveDescendantAccountabilities(ServerRequest request) {
    ...
    log.trace("Entering retrieveDescendantAccountabilities()");
    ...
    return
        ServerResponse
            ...
            .body(
                repository
                    .selectDescendantAccountabilities(
            ...
            .onErrorMap(e -> new ServerException("Descendant Accountabilities retrieval", e));
  }
