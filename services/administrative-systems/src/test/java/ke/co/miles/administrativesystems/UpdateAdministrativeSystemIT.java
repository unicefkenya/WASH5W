...
@ContextConfiguration(initializers = UpdateAdministrativeSystemIT.Initializer.class)
public class UpdateAdministrativeSystemIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/administrative_systems/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(administrativeSystem1), AdministrativeSystem.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(administrativeSystem1.getVersion() + 1);
            }
        );
  }
