...
@ContextConfiguration(initializers = RetrieveIndicatorIT.Initializer.class)
public class RetrieveIndicatorIT {
  ...
  @Test
  public void Given_IndicatorRecordExists_When_GetWithIdParameter_Then_TheIndicatorRecordWithThatIdWillBeReturned() {
    ...
    webTestClient
        ...
        .uri(uriBuilder ->
            uriBuilder
                ...
                .build(Long.toString(indicator1.getId())))
        .exchange()
        .expectStatus().isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(indicator1.getVersion());
            }
        );
  }
