...
@ContextConfiguration(initializers = RetrieveSystemModuleIT.Initializer.class)
public class RetrieveSystemModuleIT {
  ...
  @Test
  public void Given_SystemModuleRecordExists_When_GetWithIdParameter_Then_TheSystemModuleRecordWithThatIdWillBeReturned() {

    webTestClient
        .get()
        .uri(uriBuilder ->
            uriBuilder
                .path("/api/v1/systems_modules/{id}")
                .build(Long.toString(systemModule1.getId())))
        .exchange()
        .expectStatus().isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(systemModule1.getVersion());
            }
        );
  }
