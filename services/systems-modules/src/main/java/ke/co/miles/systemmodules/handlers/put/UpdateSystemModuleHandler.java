 ...
 */
package ke.co.miles.systemmodules.handlers.put;
...
@Component
@Slf4j
public class UpdateSystemModuleHandler {
   ...
   *
   * @param request the request containing the details of the systemModule record to be updated
   * @return the response containing the details of the newly updated systemModule record
   */
            ...
            .body(
                request
                    ...
                    .flatMap(systemModule ->
                        repository
                            .updateSystemModule(systemModule)
                            .map(count ->
                                new SystemModuleBuilder()
                                    .id(systemModule.getId())
                                    .data(systemModule.getData())
                                    .version(systemModule.getVersion() + 1)
                                    .build())),
                SystemModule.class)
            .onErrorMap(e -> new ServerException("SystemModule update failed", e));
