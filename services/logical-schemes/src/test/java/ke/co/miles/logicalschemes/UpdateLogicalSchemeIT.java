...
@ContextConfiguration(initializers = UpdateLogicalSchemeIT.Initializer.class)
public class UpdateLogicalSchemeIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/logical_schemes/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(logicalScheme1), LogicalScheme.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(logicalScheme1.getVersion() + 1);
            }
        );
  }
