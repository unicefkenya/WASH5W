...
@ContextConfiguration(initializers = UpdateDataFormElementCategoryIT.Initializer.class)
public class UpdateDataFormElementCategoryIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/data_forms_elements_categories/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(dataFormElementCategory1), DataFormElementCategory.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(dataFormElementCategory1.getVersion() + 1);
            }
        );
  }
