 ...
 */
package ke.co.miles.administrativestructures.handlers.put;
...
@Component
@Slf4j
public class UpdateAdministrativeStructureHandler {
   ...
   *
   * @param request the request containing the details of the administrativeStructure record to be updated
   * @return the response containing the details of the newly updated administrativeStructure record
   */
            ...
            .body(
                request
                    ...
                    .flatMap(administrativeStructure ->
                        repository
                            .updateAdministrativeStructure(administrativeStructure)
                            .map(count ->
                                new AdministrativeStructureBuilder()
                                    .id(administrativeStructure.getId())
                                    .data(administrativeStructure.getData())
                                    .version(administrativeStructure.getVersion() + 1)
                                    .build())),
                AdministrativeStructure.class)
            .onErrorMap(e -> new ServerException("AdministrativeStructure update failed", e));
