...
@ContextConfiguration(initializers = UpdateAdministrativeStructureIT.Initializer.class)
public class UpdateAdministrativeStructureIT {
  ...
  public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
    ...
    webTestClient
        .put()
        .uri("/api/v1/administrative_structures/1")
        .contentType(MediaType.APPLICATION_JSON)
        .body(Mono.just(administrativeStructure1), AdministrativeStructure.class)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .value(response -> {
              ...
              Assertions.assertThat(response.getVersion()).isEqualTo(administrativeStructure1.getVersion() + 1);
            }
        );
  }
