...
import { SystemsModulesRecordsUpdationComponent } from '../../components/systems-modules-records-updation/systems-modules-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Systems Modules Records Updation Modal]";

@Component({
    selector: 'sb-systemsModules-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-modules-records-updation-modal.component.html',
    styleUrls: ['systems-modules-records-updation-modal.component.scss'],
})
export class SystemsModulesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Module record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update System Module Record";    

    // Keeps a reference to the Systems Modules Records creation component
    private _component!: SystemsModulesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Modules Records updation component
     */
    @ViewChild(SystemsModulesRecordsUpdationComponent)
    public set component(component: SystemsModulesRecordsUpdationComponent) {
     ...
     * the Systems Modules Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Modules Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Modules Records updation component`);
