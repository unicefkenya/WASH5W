...
import { SystemsModulesRecordsDeletionComponent } from '../../components/systems-modules-records-deletion/systems-modules-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Systems Modules Records Deletion Modal]";

@Component({
    selector: 'sb-systemsModules-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-modules-records-deletion-modal.component.html',
    styleUrls: ['systems-modules-records-deletion-modal.component.scss'],
})
export class SystemsModulesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Module record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete System Module Record";    

    // Keeps a reference to the Systems Modules Records creation component
    private _component!: SystemsModulesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Modules Records deletion component
     */
    @ViewChild(SystemsModulesRecordsDeletionComponent)
    public set component(component: SystemsModulesRecordsDeletionComponent) {
     ...
     * the Systems Modules Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Systems Modules Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Modules Records deleting component`);
