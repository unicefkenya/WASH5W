...
import { SystemsModulesRecordsCreationComponent } from '../../components/systems-modules-records-creation/systems-modules-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Systems Modules Records Creation Modal]";

@Component({
    selector: 'sb-systemsModules-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-modules-records-creation-modal.component.html',
    styleUrls: ['systems-modules-records-creation-modal.component.scss'],
})
export class SystemsModulesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create System Module Record";

    // Keeps a reference to the Systems Modules Records creation component
    private _component!: SystemsModulesRecordsCreationComponent;
    ...
    constructor(
        public activeSystemsModulesModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Systems Modules Records creation component
     */
    @ViewChild(SystemsModulesRecordsCreationComponent)
    public set component(component: SystemsModulesRecordsCreationComponent) {
     ...
     * the Systems Modules Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Modules Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Modules Records creation component`);
    ...
    onQuit() {
        ...
        this.activeSystemsModulesModal.close();
    }
