...
import { DataFormsGroupsRecordsUpdationComponent } from '@modules/data-forms-elements/components/data-forms-groups-records-updation/data-forms-groups-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Data Forms Groups Records Creation Modal]";

@Component({
    selector: 'sb-data-forms-groups-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-groups-records-updation-modal.component.html',
    styleUrls: ['data-forms-groups-records-updation-modal.component.scss'],
})
export class DataFormsGroupsRecordsUpdationModalComponent implements OnInit, OnDestroy {

    // Allows the parent component to inject the unique identifier of the Data Form Group
    ...
    public title: string = "Update Data Form Group";
    ...
    private _component!: DataFormsGroupsRecordsUpdationComponent;
     ...
     */
    @ViewChild(DataFormsGroupsRecordsUpdationComponent)
    public set component(component: DataFormsGroupsRecordsUpdationComponent) {
