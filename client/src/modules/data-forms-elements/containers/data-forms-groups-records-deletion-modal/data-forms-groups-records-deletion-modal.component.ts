...
import { DataFormsGroupsRecordsDeletionComponent } from '../../components/data-forms-groups-records-deletion/data-forms-groups-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Data Forms Groups Records Deletion Modal]";

@Component({
    selector: 'sb-data-forms-groups-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-groups-records-deletion-modal.component.html',
    styleUrls: ['data-forms-groups-records-deletion-modal.component.scss'],
})
export class DataFormsGroupsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Data Form Element record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Data Form Group";    

    // Keeps a reference to the Data Forms Elements Records creation component
    private _component!: DataFormsGroupsRecordsDeletionComponent;
     ...
     */
    @ViewChild(DataFormsGroupsRecordsDeletionComponent)
    public set component(component: DataFormsGroupsRecordsDeletionComponent) {
