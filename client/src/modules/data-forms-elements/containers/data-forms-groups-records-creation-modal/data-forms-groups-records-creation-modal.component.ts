...
import { DataFormsGroupsRecordsCreationComponent } from '@modules/data-forms-elements/components/data-forms-groups-records-creation/data-forms-groups-records-creation.component';
...
@Component({
    selector: 'sb-data-forms-groups-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-groups-records-creation-modal.component.html',
    styleUrls: ['data-forms-groups-records-creation-modal.component.scss'],
})
export class DataFormsGroupsRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    public title: string = "Create Data Form Group";
    ...
    private _component!: DataFormsGroupsRecordsCreationComponent;
     ...
     */
    @ViewChild(DataFormsGroupsRecordsCreationComponent)
    public set component(component: DataFormsGroupsRecordsCreationComponent) {
