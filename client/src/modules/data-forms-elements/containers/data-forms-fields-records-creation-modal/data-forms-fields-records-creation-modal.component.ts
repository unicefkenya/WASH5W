...
import { DataFormsFieldsRecordsCreationComponent } from '../../components/data-forms-fields-records-creation/data-forms-fields-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Data Forms Fields Records Creation Modal]";

@Component({
    selector: 'sb-data-forms-fields-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-fields-records-creation-modal.component.html',
    styleUrls: ['data-forms-fields-records-creation-modal.component.scss'],
})
export class DataFormsFieldsRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    public title: string = "Create Data Form Field";
    ...
    // Keeps a reference to the Data Forms Elements Records creation component
    private _component!: DataFormsFieldsRecordsCreationComponent;
     ...
     */
    @ViewChild(DataFormsFieldsRecordsCreationComponent)
    public set component(component: DataFormsFieldsRecordsCreationComponent) {
    ...
    public onSave(): void {
        ...
        // Call the save function in the Data Forms Elements Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Data Forms Elements Records creation component`);
     ...
     */
     public closeFieldTypeSelector(): void {
        ...
        // Call the closeFieldTypeSelector function in the Data Forms Elements Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the closeFieldTypeSelector function in the Data Forms Elements Records creation component`);
    ...
    public closeFieldSelector(): void {
        ...
        // Call the closeFieldSelector function in the Data Forms Elements Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the closeFieldSelector function in the Data Forms Elements Records creation component`);
