...
import { DataFormsFieldsRecordsDeletionComponent } from '../../components/data-forms-fields-records-deletion/data-forms-fields-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Data Forms Fields Records Deletion Modal]";

@Component({
    selector: 'sb-data-forms-fields-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-fields-records-deletion-modal.component.html',
    styleUrls: ['data-forms-fields-records-deletion-modal.component.scss'],
})
export class DataFormsFieldsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Data Form Element record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Data Form Field";    

    // Keeps a reference to the Data Forms Elements Records creation component
    private _component!: DataFormsFieldsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Data Forms Elements Records deletion component
     */
    @ViewChild(DataFormsFieldsRecordsDeletionComponent)
    public set component(component: DataFormsFieldsRecordsDeletionComponent) {
     ...
     * the Data Forms Elements Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Data Forms Elements Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Data Forms Elements Records deleting component`);
