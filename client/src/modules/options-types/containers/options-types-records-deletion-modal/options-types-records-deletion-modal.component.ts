...
import { OptionsTypesRecordsDeletionComponent } from '../../components/options-types-records-deletion/options-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Options Types Records Deletion Modal]";

@Component({
    selector: 'sb-optionsTypes-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './options-types-records-deletion-modal.component.html',
    styleUrls: ['options-types-records-deletion-modal.component.scss'],
})
export class OptionsTypesRecordsDeletionModalComponent implements OnInit {
    ...
    private _component!: OptionsTypesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Options Types Records deletion component
     */
    @ViewChild(OptionsTypesRecordsDeletionComponent)
    public set component(component: OptionsTypesRecordsDeletionComponent) {
     ...
     * the Options Types Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Options Types Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Options Types Records deleting component`);
