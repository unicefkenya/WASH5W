...
import { LogicalHierarchiesRecordsDeletionComponent } from '../../components/logical-hierarchies-records-deletion/logical-hierarchies-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Logical Hierarchies Records Deletion Modal]";

@Component({
    selector: 'sb-logical-hierarchies-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-hierarchies-records-deletion-modal.component.html',
    styleUrls: ['logical-hierarchies-records-deletion-modal.component.scss'],
})
export class LogicalHierarchiesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Hierarchy record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Logical Hierarchy Record";    

    // Keeps a reference to the Logical Hierarchies Records creation component
    private _component!: LogicalHierarchiesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Hierarchies Records deletion component
     */
    @ViewChild(LogicalHierarchiesRecordsDeletionComponent)
    public set component(component: LogicalHierarchiesRecordsDeletionComponent) {
     ...
     * the Logical Hierarchies Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Logical Hierarchies Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Hierarchies Records deleting component`);
