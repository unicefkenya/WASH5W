...
export class PaginationComponent implements OnInit, OnDestroy {
   ...
   */
  public initialise(page: number, pageSize: number): void {

    this.log.debug(`${LOG_PREFIX} Initialising Page to ${page}`);
    this.page = page;

    this.log.debug(`${LOG_PREFIX} Initialising Page Size to ${pageSize}`);
