...
import { QuantitiesObservationsRecordsDeletionComponent } from '../../components/quantities-observations-records-deletion/quantities-observations-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[QuantitiesObservations Records Deletion Modal]";

@Component({
    selector: 'sb-quantities-observations-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './quantities-observations-records-deletion-modal.component.html',
    styleUrls: ['quantities-observations-records-deletion-modal.component.scss'],
})
export class QuantitiesObservationsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Quantity Observation Record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Quantity Observation Record";    

    // Keeps a reference to the QuantitiesObservations Records creation component
    private _component!: QuantitiesObservationsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed QuantitiesObservations Records deletion component
     */
    @ViewChild(QuantitiesObservationsRecordsDeletionComponent)
    public set component(component: QuantitiesObservationsRecordsDeletionComponent) {
     ...
     * the QuantitiesObservations Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the QuantitiesObservations Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the QuantitiesObservations Records deleting component`);
