...
import { EntitiesTypesRecordsDeletionComponent } from '../../components/entities-types-records-deletion/entities-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Entities Types Records Deletion Modal]";

@Component({
    selector: 'sb-entities-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './entities-types-records-deletion-modal.component.html',
    styleUrls: ['entities-types-records-deletion-modal.component.scss'],
})
export class EntitiesTypesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Entity Type record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Entity Type Record";    

    // Keeps a reference to the Entities Types Records creation component
    private _component!: EntitiesTypesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Entities Types Records deletion component
     */
    @ViewChild(EntitiesTypesRecordsDeletionComponent)
    public set component(component: EntitiesTypesRecordsDeletionComponent) {
     ...
     * the Entities Types Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Entities Types Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Entities Types Records deleting component`);
