...
const LOG_PREFIX: string = "[Logical Structures Selection Data Service]";
const HEADERS = { 'Content-Type': 'application/json' };

@Injectable({
  providedIn: 'root'
})
export class LogicalStructuresSelectionDataService {
  ...
  private getFreshLogicalStructures(cache: boolean, state: LogicalStructureState): Observable<LogicalStructure[]> {
    ...
    return this.http.get<LogicalStructure[]>(`${this.url}`, { headers: new HttpHeaders(HEADERS), params: new HttpParams({ fromObject: this.getQueryParams(state) }), observe: 'response' })
      .pipe(
