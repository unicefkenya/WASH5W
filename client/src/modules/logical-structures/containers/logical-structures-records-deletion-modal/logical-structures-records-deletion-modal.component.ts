...
import { LogicalStructuresRecordsDeletionComponent } from '../../components/logical-structures-records-deletion/logical-structures-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Logical Structures Records Deletion Modal]";

@Component({
    selector: 'sb-logical-structures-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-structures-records-deletion-modal.component.html',
    styleUrls: ['logical-structures-records-deletion-modal.component.scss'],
})
export class LogicalStructuresRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Structure record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Logical Structure Record";    

    // Keeps a reference to the Logical Structures Records creation component
    private _component!: LogicalStructuresRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Structures Records deletion component
     */
    @ViewChild(LogicalStructuresRecordsDeletionComponent)
    public set component(component: LogicalStructuresRecordsDeletionComponent) {
     ...
     * the Logical Structures Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Logical Structures Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Structures Records deleting component`);
