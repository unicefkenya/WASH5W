...
import { LogicalStructuresRecordsUpdationComponent } from '../../components/logical-structures-records-updation/logical-structures-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Logical Structures Records Updation Modal]";

@Component({
    selector: 'sb-logical-structures-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-structures-records-updation-modal.component.html',
    styleUrls: ['logical-structures-records-updation-modal.component.scss'],
})
export class LogicalStructuresRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Structure record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Logical Structure Record";

    // Keeps a reference to the Logical Structures Records creation component
    private _component!: LogicalStructuresRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Structures Records updation component
     */
    @ViewChild(LogicalStructuresRecordsUpdationComponent)
    public set component(component: LogicalStructuresRecordsUpdationComponent) {
     ...
     * the Logical Structures Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Structures Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Structures Records updation component`);
