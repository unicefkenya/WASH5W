...
import { DissagregationsRecordsUpdationComponent } from '../../components/dissagregations-records-updation/dissagregations-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Dissagregations Records Updation Modal]";

@Component({
    selector: 'sb-dissagregations-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-records-updation-modal.component.html',
    styleUrls: ['dissagregations-records-updation-modal.component.scss'],
})
export class DissagregationsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Dissagregation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Dissagregation Record";    

    // Keeps a reference to the Dissagregations Records creation component
    private _component!: DissagregationsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Dissagregations Records updation component
     */
    @ViewChild(DissagregationsRecordsUpdationComponent)
    public set component(component: DissagregationsRecordsUpdationComponent) {
     ...
     * the Dissagregations Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Dissagregations Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Dissagregations Records updation component`);
