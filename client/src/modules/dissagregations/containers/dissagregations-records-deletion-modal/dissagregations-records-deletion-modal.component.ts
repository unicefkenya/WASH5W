...
import { DissagregationsRecordsDeletionComponent } from '../../components/dissagregations-records-deletion/dissagregations-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Dissagregations Records Deletion Modal]";

@Component({
    selector: 'sb-dissagregations-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-records-deletion-modal.component.html',
    styleUrls: ['dissagregations-records-deletion-modal.component.scss'],
})
export class DissagregationsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Dissagregation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Dissagregation Record";    

    // Keeps a reference to the Dissagregations Records creation component
    private _component!: DissagregationsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Dissagregations Records deletion component
     */
    @ViewChild(DissagregationsRecordsDeletionComponent)
    public set component(component: DissagregationsRecordsDeletionComponent) {
     ...
     * the Dissagregations Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Dissagregations Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Dissagregations Records deleting component`);
