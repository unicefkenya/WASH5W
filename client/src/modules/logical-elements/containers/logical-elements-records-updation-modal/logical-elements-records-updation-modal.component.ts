...
import { LogicalElementsRecordsUpdationComponent } from '../../components/logical-elements-records-updation/logical-elements-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Logical Elements Records Updation Modal]";

@Component({
    selector: 'sb-logical-elements-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-records-updation-modal.component.html',
    styleUrls: ['logical-elements-records-updation-modal.component.scss'],
})
export class LogicalElementsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Element record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Logical Element Record";    

    // Keeps a reference to the Logical Elements Records creation component
    private _component!: LogicalElementsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Records updation component
     */
    @ViewChild(LogicalElementsRecordsUpdationComponent)
    public set component(component: LogicalElementsRecordsUpdationComponent) {
     ...
     * the Logical Elements Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Elements Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Records updation component`);
