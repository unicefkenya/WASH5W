...
import { LogicalElementsRecordsDeletionComponent } from '../../components/logical-elements-records-deletion/logical-elements-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Logical Elements Records Deletion Modal]";

@Component({
    selector: 'sb-logical-elements-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-records-deletion-modal.component.html',
    styleUrls: ['logical-elements-records-deletion-modal.component.scss'],
})
export class LogicalElementsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Element record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Logical Element Record";    

    // Keeps a reference to the Logical Elements Records creation component
    private _component!: LogicalElementsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Records deletion component
     */
    @ViewChild(LogicalElementsRecordsDeletionComponent)
    public set component(component: LogicalElementsRecordsDeletionComponent) {
     ...
     * the Logical Elements Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Logical Elements Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Records deleting component`);
