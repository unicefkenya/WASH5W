...
import { LogicalElementsRecordsCreationComponent } from '../../components/logical-elements-records-creation/logical-elements-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Logical Elements Records Creation Modal]";

@Component({
    selector: 'sb-logical-elements-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-records-creation-modal.component.html',
    styleUrls: ['logical-elements-records-creation-modal.component.scss'],
})
export class LogicalElementsRecordsCreationModalComponent implements OnInit, OnDestroy {

  // Allows the parent component to inject the unique identifier of the parent Context record
  @Input() public contextId!: number;    

    // Allows the parent component to inject the unique identifier of the parent Type record
    @Input() public typeId!: number;

    // Keeps tab of the page title
    public title: string = "Create Logical Element Record";

    // Keeps a reference to the Logical Elements Records creation component
    private _component!: LogicalElementsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Records creation component
     */
    @ViewChild(LogicalElementsRecordsCreationComponent)
    public set component(component: LogicalElementsRecordsCreationComponent) {
     ...
     * the Logical Elements Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Elements Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Records creation component`);
