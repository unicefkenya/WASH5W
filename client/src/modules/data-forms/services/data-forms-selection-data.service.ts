...
const LOG_PREFIX: string = "[Data Forms Selection Data Service]";
const HEADERS = { 'Content-Type': 'application/json' };

@Injectable({
  providedIn: 'root'
})
export class DataFormsSelectionDataService {
  ...
  private getFreshDataForms(cache: boolean, state: DataFormState): Observable<DataForm[]> {
    ...
    return this.http.get<DataForm[]>(`${this.url}`, { headers: new HttpHeaders(HEADERS), params: new HttpParams({ fromObject: this.getQueryParams(state) }), observe: 'response' })
      .pipe(
