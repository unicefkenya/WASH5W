...
import { DataFormsRecordsUpdationComponent } from '../../components/data-forms-records-updation/data-forms-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Data Forms Records Updation Modal]";

@Component({
    selector: 'sb-data-forms-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './data-forms-records-updation-modal.component.html',
    styleUrls: ['data-forms-records-updation-modal.component.scss'],
})
export class DataFormsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Data Form record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Data Form Record";    

    // Keeps a reference to the Data Forms Records creation component
    private _component!: DataFormsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Data Forms Records updation component
     */
    @ViewChild(DataFormsRecordsUpdationComponent)
    public set component(component: DataFormsRecordsUpdationComponent) {
     ...
     * the Data Forms Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Data Forms Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Data Forms Records updation component`);
