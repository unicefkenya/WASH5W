...
const LOG_PREFIX: string = "[Administrative Hierarchies Records Selection Component]";

@Component({
    selector: 'sb-administrative-hierarchies-records-selection',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-hierarchies-records-selection.component.html',
    styleUrls: ['administrative-hierarchies-records-selection.component.scss'],
})
export class AdministrativeHierarchiesRecordsSelectionComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    */
    onSelect(administrativeHierarchy: AdministrativeHierarchy) {
        ...
        if (this.full) {
            ...
            const predecessors: AdministrativeHierarchy[] = Object.assign([], this.filterService.filter.openedAdministrativeHierarchies);
