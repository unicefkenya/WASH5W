...
const LOG_PREFIX: string = "[Administrative Hierarchies Records Selection Modal]";

@Component({
    selector: 'sb-administrative-hierarchies-records-selection-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-hierarchies-records-selection-modal.component.html',
    styleUrls: ['administrative-hierarchies-records-selection-modal.component.scss'],
})
export class AdministrativeHierarchiesRecordsSelectionModalComponent implements OnInit {
