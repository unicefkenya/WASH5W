...
import { AdministrativeHierarchiesRecordsDeletionComponent } from '../../components/administrative-hierarchies-records-deletion/administrative-hierarchies-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Hierarchies Records Deletion Modal]";

@Component({
    selector: 'sb-administrative-hierarchies-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-hierarchies-records-deletion-modal.component.html',
    styleUrls: ['administrative-hierarchies-records-deletion-modal.component.scss'],
})
export class AdministrativeHierarchiesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative Hierarchy record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Administrative Hierarchy Record";    

    // Keeps a reference to the Administrative Hierarchies Records creation component
    private _component!: AdministrativeHierarchiesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Hierarchies Records deletion component
     */
    @ViewChild(AdministrativeHierarchiesRecordsDeletionComponent)
    public set component(component: AdministrativeHierarchiesRecordsDeletionComponent) {
     ...
     * the Administrative Hierarchies Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Administrative Hierarchies Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Hierarchies Records deleting component`);
