...
import { VisualisationVariablesRecordsDeletionComponent } from '../../components/visualisation-variables-records-deletion/visualisation-variables-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Visualisation Variables Records Deletion Modal]";

@Component({
    selector: 'sb-visualisation-variables-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisation-variables-records-deletion-modal.component.html',
    styleUrls: ['visualisation-variables-records-deletion-modal.component.scss'],
})
export class VisualisationVariablesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation Variable record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Visualisation Variable Record";    

    // Keeps a reference to the Visualisation Variables Records creation component
    private _component!: VisualisationVariablesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisation Variables Records deletion component
     */
    @ViewChild(VisualisationVariablesRecordsDeletionComponent)
    public set component(component: VisualisationVariablesRecordsDeletionComponent) {
     ...
     * the Visualisation Variables Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Visualisation Variables Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisation Variables Records deleting component`);
