...
import { OrganisationsTypesRecordsCreationComponent } from '../../components/organisations-types-records-creation/organisations-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Organisations Types Records Creation Modal]";

@Component({
    selector: 'sb-organisationsTypes-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './organisations-types-records-creation-modal.component.html',
    styleUrls: ['organisations-types-records-creation-modal.component.scss'],
})
export class OrganisationsTypesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Organisation Type Record";

    // Keeps a reference to the Organisations Types Records creation component
    private _component!: OrganisationsTypesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Organisations Types Records creation component
     */
    @ViewChild(OrganisationsTypesRecordsCreationComponent)
    public set component(component: OrganisationsTypesRecordsCreationComponent) {
     ...
     * the Organisations Types Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Organisations Types Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Organisations Types Records creation component`);
