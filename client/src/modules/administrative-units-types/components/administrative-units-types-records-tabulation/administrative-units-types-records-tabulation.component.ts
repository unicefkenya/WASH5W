...
import { AdministrativeUnitsTypesRecordsCreationModalComponent } from '@modules/administrative-units-types/containers/administrative-units-types-records-creation-modal/administrative-units-types-records-creation-modal.component';
import { AdministrativeUnitsTypesRecordsDeletionModalComponent } from '@modules/administrative-units-types/containers/administrative-units-types-records-deletion-modal/administrative-units-types-records-deletion-modal.component';
import { AdministrativeUnitsTypesRecordsUpdationModalComponent } from '@modules/administrative-units-types/containers/administrative-units-types-records-updation-modal/administrative-units-types-records-updation-modal.component';
...
const LOG_PREFIX: string = "[Administrative Units Types Records Tabulation Component]";

@Component({
    selector: 'sb-administrativeUnitsTypes-records-tabulation',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-types-records-tabulation.component.html',
    styleUrls: ['administrative-units-types-records-tabulation.component.scss'],
})
export class AdministrativeUnitsTypesRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    /**
     * Handles Administrative Units Types Records Addition Requests
     */
    public onAddAdministrativeUnitType(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddAdministrativeUnitType()`);

        this.modalService.open(AdministrativeUnitsTypesRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Administrative Units Types Records Updation Requests
     */
    public onUpdateAdministrativeUnitType(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateAdministrativeUnitType()`);
        this.log.debug(`${LOG_PREFIX} Administrative Unit Type Id = ${id}`);

        const modalRef = this.modalService.open(AdministrativeUnitsTypesRecordsUpdationModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;

    }

    /**
     * Handles Administrative Units Types Records Deletion Requests
     */
    public onDeleteAdministrativeUnitType(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteAdministrativeUnitType()`);
        this.log.debug(`${LOG_PREFIX} Administrative Unit Type Id = ${id}`);

        const modalRef = this.modalService.open(AdministrativeUnitsTypesRecordsDeletionModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;
    }
