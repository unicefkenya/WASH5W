...
import { AdministrativeUnitsTypesRecordsUpdationComponent } from '../../components/administrative-units-types-records-updation/administrative-units-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Administrative Units Types Records Updation Modal]";

@Component({
    selector: 'sb-administrativeUnitsTypes-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-types-records-updation-modal.component.html',
    styleUrls: ['administrative-units-types-records-updation-modal.component.scss'],
})
export class AdministrativeUnitsTypesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative Unit Type record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Administrative Unit Type Record";    

    // Keeps a reference to the Administrative Units Types Records creation component
    private _component!: AdministrativeUnitsTypesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Units Types Records updation component
     */
    @ViewChild(AdministrativeUnitsTypesRecordsUpdationComponent)
    public set component(component: AdministrativeUnitsTypesRecordsUpdationComponent) {
     ...
     * the Administrative Units Types Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Units Types Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Units Types Records updation component`);
