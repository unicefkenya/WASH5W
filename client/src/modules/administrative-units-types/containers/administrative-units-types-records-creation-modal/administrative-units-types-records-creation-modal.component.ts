...
import { AdministrativeUnitsTypesRecordsCreationComponent } from '../../components/administrative-units-types-records-creation/administrative-units-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Units Types Records Creation Modal]";

@Component({
    selector: 'sb-administrativeUnitsTypes-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-types-records-creation-modal.component.html',
    styleUrls: ['administrative-units-types-records-creation-modal.component.scss'],
})
export class AdministrativeUnitsTypesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Administrative Unit Type Record";

    // Keeps a reference to the Administrative Units Types Records creation component
    private _component!: AdministrativeUnitsTypesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Units Types Records creation component
     */
    @ViewChild(AdministrativeUnitsTypesRecordsCreationComponent)
    public set component(component: AdministrativeUnitsTypesRecordsCreationComponent) {
     ...
     * the Administrative Units Types Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Units Types Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Units Types Records creation component`);
