...
import { VisualisationsRecordsUpdationComponent } from '../../components/visualisations-records-updation/visualisations-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Visualisations Records Updation Modal]";

@Component({
    selector: 'sb-visualisations-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisations-records-updation-modal.component.html',
    styleUrls: ['visualisations-records-updation-modal.component.scss'],
})
export class VisualisationsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Visualisation Record";    

    // Keeps a reference to the Visualisations Records creation component
    private _component!: VisualisationsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisations Records updation component
     */
    @ViewChild(VisualisationsRecordsUpdationComponent)
    public set component(component: VisualisationsRecordsUpdationComponent) {
     ...
     * the Visualisations Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisations Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisations Records updation component`);
