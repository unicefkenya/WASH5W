...
import { VisualisationsRecordsCreationComponent } from '../../components/visualisations-records-creation/visualisations-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Visualisations Records Creation Modal]";

@Component({
    selector: 'sb-visualisations-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisations-records-creation-modal.component.html',
    styleUrls: ['visualisations-records-creation-modal.component.scss'],
})
export class VisualisationsRecordsCreationModalComponent implements OnInit, OnDestroy {
  ...
  @Input() public containerId!: number;
    ...
    public title: string = "Create Visualisation Record";

    // Keeps a reference to the Visualisations Records creation component
    private _component!: VisualisationsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisations Records creation component
     */
    @ViewChild(VisualisationsRecordsCreationComponent)
    public set component(component: VisualisationsRecordsCreationComponent) {
     ...
     * the Visualisations Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisations Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisations Records creation component`);
