...
import { VisualisationsRecordsDeletionComponent } from '../../components/visualisations-records-deletion/visualisations-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Visualisations Records Deletion Modal]";

@Component({
    selector: 'sb-visualisations-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisations-records-deletion-modal.component.html',
    styleUrls: ['visualisations-records-deletion-modal.component.scss'],
})
export class VisualisationsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Visualisation Record";    

    // Keeps a reference to the Visualisations Records creation component
    private _component!: VisualisationsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisations Records deletion component
     */
    @ViewChild(VisualisationsRecordsDeletionComponent)
    public set component(component: VisualisationsRecordsDeletionComponent) {
     ...
     * the Visualisations Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Visualisations Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisations Records deleting component`);
