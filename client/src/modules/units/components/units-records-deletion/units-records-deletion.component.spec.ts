...
import { UnitsRecordsDeletionComponent } from '../units-records-deletion/units-records-deletion.component';
...
describe('UnitsRecordsDeletionComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, UnitsRecordsDeletionComponent, PaginationComponent, LoadingAnimationComponent],
