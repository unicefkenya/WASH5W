...
export class UnitsRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    /**
     * Handles Units Records Addition Requests
     */
    public onAddUnit(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddUnit()`);

        this.modalService.open(UnitsRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Units Records Updation Requests
     */
    public onUpdateUnit(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateUnit()`);
        this.log.debug(`${LOG_PREFIX} Unit Id = ${id}`);
    ...
    /**
     * Handles Units Records Deletion Requests
     */
    public onDeleteUnit(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteUnit()`);
        this.log.debug(`${LOG_PREFIX} Unit Id = ${id}`);
