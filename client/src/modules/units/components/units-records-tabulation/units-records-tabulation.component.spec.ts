...
@Component({
    template: `
        <sb-units-records-tabulation [someInput]="someInput" (someFunction)="someFunction($event)"></sb-units-records-tabulation>
    `,
})
...
describe('UnitsRecordsTabulationComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, UnitsRecordsTabulationComponent, PaginationComponent, LoadingAnimationComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sb-units-records-tabulation')).toEqual(jasmine.anything());
    });
});