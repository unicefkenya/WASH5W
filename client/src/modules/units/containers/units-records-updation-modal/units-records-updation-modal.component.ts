...
export class UnitsRecordsUpdationModalComponent implements OnInit {
    ...
    public title: string = "Update Unit Record";    

    // Keeps a reference to the Units Records creation component
    private _component!: UnitsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Units Records updation component
     */
    @ViewChild(UnitsRecordsUpdationComponent)
    public set component(component: UnitsRecordsUpdationComponent) {
     ...
     * the Units Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Units Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Units Records updation component`);
