...
export class UnitsRecordsTabulationPageComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Indicators Units";

    // Keeps tab of the page subtitle
    public subtitle: string = "Indicators units of measure";
