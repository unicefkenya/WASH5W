...
@Component({
    selector: 'sb-time-periods-records-selection-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './time-periods-records-selection-modal.component.html',
    styleUrls: ['time-periods-records-selection-modal.component.scss'],
})
export class TimePeriodsRecordsSelectionModalComponent implements OnInit {
