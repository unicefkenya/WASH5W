...
import { EntitiesRecordsUpdationComponent } from '../../components/entities-records-updation/entities-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Entities Records Updation Modal]";

@Component({
    selector: 'sb-entities-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './entities-records-updation-modal.component.html',
    styleUrls: ['entities-records-updation-modal.component.scss'],
})
export class EntitiesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Entity record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Entity Record";    

    // Keeps a reference to the Entities Records creation component
    private _component!: EntitiesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Entities Records updation component
     */
    @ViewChild(EntitiesRecordsUpdationComponent)
    public set component(component: EntitiesRecordsUpdationComponent) {
     ...
     * the Entities Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Entities Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Entities Records updation component`);
