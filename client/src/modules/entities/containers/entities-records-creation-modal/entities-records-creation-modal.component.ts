...
import { EntitiesRecordsCreationComponent } from '../../components/entities-records-creation/entities-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Entities Records Creation Modal]";

@Component({
    selector: 'sb-entities-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './entities-records-creation-modal.component.html',
    styleUrls: ['entities-records-creation-modal.component.scss'],
})
export class EntitiesRecordsCreationModalComponent implements OnInit, OnDestroy {
  ...
  @Input() public contextId!: number;    
    ...
    public title: string = "Create Entity Record";

    // Keeps a reference to the Entities Records creation component
    private _component!: EntitiesRecordsCreationComponent;
     ...
     */
    @ViewChild(EntitiesRecordsCreationComponent)
    public set component(component: EntitiesRecordsCreationComponent) {
