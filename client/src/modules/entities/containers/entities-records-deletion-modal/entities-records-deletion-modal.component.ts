...
import { EntitiesRecordsDeletionComponent } from '../../components/entities-records-deletion/entities-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Entities Records Deletion Modal]";

@Component({
    selector: 'sb-entities-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './entities-records-deletion-modal.component.html',
    styleUrls: ['entities-records-deletion-modal.component.scss'],
})
export class EntitiesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Entity record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Entity Record";    

    // Keeps a reference to the Entities Records creation component
    private _component!: EntitiesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Entities Records deletion component
     */
    @ViewChild(EntitiesRecordsDeletionComponent)
    public set component(component: EntitiesRecordsDeletionComponent) {
     ...
     * the Entities Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Entities Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Entities Records deleting component`);
