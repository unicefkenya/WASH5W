...
import { LogicalElementsTypesRecordsCreationComponent } from '../../components/logical-elements-types-records-creation/logical-elements-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Logical Elements Types Records Creation Modal]";

@Component({
    selector: 'sb-logicalElementsTypes-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-types-records-creation-modal.component.html',
    styleUrls: ['logical-elements-types-records-creation-modal.component.scss'],
})
export class LogicalElementsTypesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Logical Element Type Record";

    // Keeps a reference to the Logical Elements Types Records creation component
    private _component!: LogicalElementsTypesRecordsCreationComponent;
    ...
    constructor(
        public activeLogicalElementsTypesModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Types Records creation component
     */
    @ViewChild(LogicalElementsTypesRecordsCreationComponent)
    public set component(component: LogicalElementsTypesRecordsCreationComponent) {
     ...
     * the Logical Elements Types Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Elements Types Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Types Records creation component`);
    ...
    onQuit() {
        ...
        this.activeLogicalElementsTypesModal.close();
    }
