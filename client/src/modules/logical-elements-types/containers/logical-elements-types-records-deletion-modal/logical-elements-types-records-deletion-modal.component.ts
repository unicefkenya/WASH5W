...
import { LogicalElementsTypesRecordsDeletionComponent } from '../../components/logical-elements-types-records-deletion/logical-elements-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Logical Elements Types Records Deletion Modal]";

@Component({
    selector: 'sb-logicalElementsTypes-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-types-records-deletion-modal.component.html',
    styleUrls: ['logical-elements-types-records-deletion-modal.component.scss'],
})
export class LogicalElementsTypesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Element Type record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Logical Element Type Record";    

    // Keeps a reference to the Logical Elements Types Records creation component
    private _component!: LogicalElementsTypesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Types Records deletion component
     */
    @ViewChild(LogicalElementsTypesRecordsDeletionComponent)
    public set component(component: LogicalElementsTypesRecordsDeletionComponent) {
     ...
     * the Logical Elements Types Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Logical Elements Types Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Types Records deleting component`);
