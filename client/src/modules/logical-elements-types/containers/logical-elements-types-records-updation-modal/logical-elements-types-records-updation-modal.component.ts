...
import { LogicalElementsTypesRecordsUpdationComponent } from '../../components/logical-elements-types-records-updation/logical-elements-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Logical Elements Types Records Updation Modal]";

@Component({
    selector: 'sb-logicalElementsTypes-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-elements-types-records-updation-modal.component.html',
    styleUrls: ['logical-elements-types-records-updation-modal.component.scss'],
})
export class LogicalElementsTypesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Element Type record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Logical Element Type Record";    

    // Keeps a reference to the Logical Elements Types Records creation component
    private _component!: LogicalElementsTypesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Elements Types Records updation component
     */
    @ViewChild(LogicalElementsTypesRecordsUpdationComponent)
    public set component(component: LogicalElementsTypesRecordsUpdationComponent) {
     ...
     * the Logical Elements Types Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Elements Types Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Elements Types Records updation component`);
