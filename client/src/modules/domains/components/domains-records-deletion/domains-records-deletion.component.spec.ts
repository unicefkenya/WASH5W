...
import { DomainsDataService } from '@modules/domains/services';
import { LoggerModule, NgxLoggerLevel } from 'ngx-logger';
import { DomainsRecordsDeletionComponent } from '../domains-records-deletion/domains-records-deletion.component';
...
describe('DomainsRecordsDeletionComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, DomainsRecordsDeletionComponent, PaginationComponent, LoadingAnimationComponent],
            imports: [HttpClientTestingModule, LoggerModule.forRoot({ serverLoggingUrl: '/api/logs', level: NgxLoggerLevel.TRACE, serverLogLevel: NgxLoggerLevel.OFF })],
            providers: [DomainsDataService, EmailService, ConnectivityStatusService],
