...
@Component({
    template: `
        <sb-domains-records-tabulation [someInput]="someInput" (someFunction)="someFunction($event)"></sb-domains-records-tabulation>
    `,
})
...
describe('DomainsRecordsTabulationComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, DomainsRecordsTabulationComponent, PaginationComponent, LoadingAnimationComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sb-domains-records-tabulation')).toEqual(jasmine.anything());
    });
});