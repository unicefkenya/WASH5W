...
import { DomainsRecordsCreationModalComponent } from '@modules/domains/containers/domains-records-creation-modal/domains-records-creation-modal.component';
import { DomainsRecordsDeletionModalComponent } from '@modules/domains/containers/domains-records-deletion-modal/domains-records-deletion-modal.component';
import { DomainsRecordsUpdationModalComponent } from '@modules/domains/containers/domains-records-updation-modal/domains-records-updation-modal.component';
...
const LOG_PREFIX: string = "[Domains Records Tabulation Component]";
...
export class DomainsRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    /**
     * Handles Domains Records Addition Requests
     */
    public onAddDomain(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddDomain()`);

        this.modalService.open(DomainsRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Domains Records Updation Requests
     */
    public onUpdateDomain(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateDomain()`);
        this.log.debug(`${LOG_PREFIX} Domain Id = ${id}`);
    ...
    /**
     * Handles Domains Records Deletion Requests
     */
    public onDeleteDomain(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteDomain()`);
        this.log.debug(`${LOG_PREFIX} Domain Id = ${id}`);
