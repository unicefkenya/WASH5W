...
export class DomainsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Domain Record";

    // Keeps a reference to the Domains Records creation component
    private _component!: DomainsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Domains Records creation component
     */
    @ViewChild(DomainsRecordsCreationComponent)
    public set component(component: DomainsRecordsCreationComponent) {
     ...
     * the Domains Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Domains Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Domains Records creation component`);
