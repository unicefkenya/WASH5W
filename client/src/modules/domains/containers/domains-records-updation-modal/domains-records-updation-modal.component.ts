...
export class DomainsRecordsUpdationModalComponent implements OnInit {
    ...
    public title: string = "Update Domain Record";    

    // Keeps a reference to the Domains Records creation component
    private _component!: DomainsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Domains Records updation component
     */
    @ViewChild(DomainsRecordsUpdationComponent)
    public set component(component: DomainsRecordsUpdationComponent) {
     ...
     * the Domains Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Domains Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Domains Records updation component`);
