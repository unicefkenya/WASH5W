...
import { DissagregationsSchemesRecordsCreationComponent } from '../../components/dissagregations-schemes-records-creation/dissagregations-schemes-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Dissagregations Schemes Records Creation Modal]";

@Component({
    selector: 'sb-dissagregationsSchemes-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-schemes-records-creation-modal.component.html',
    styleUrls: ['dissagregations-schemes-records-creation-modal.component.scss'],
})
export class DissagregationsSchemesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    private _component!: DissagregationsSchemesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Dissagregations Schemes Records creation component
     */
    @ViewChild(DissagregationsSchemesRecordsCreationComponent)
    public set component(component: DissagregationsSchemesRecordsCreationComponent) {
     ...
     * the Dissagregations Schemes Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Dissagregations Schemes Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Dissagregations Schemes Records creation component`);
