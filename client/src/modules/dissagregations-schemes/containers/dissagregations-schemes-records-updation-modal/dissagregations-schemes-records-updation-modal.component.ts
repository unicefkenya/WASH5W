...
import { DissagregationsSchemesRecordsUpdationComponent } from '../../components/dissagregations-schemes-records-updation/dissagregations-schemes-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Dissagregations Schemes Records Updation Modal]";

@Component({
    selector: 'sb-dissagregationsSchemes-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-schemes-records-updation-modal.component.html',
    styleUrls: ['dissagregations-schemes-records-updation-modal.component.scss'],
})
export class DissagregationsSchemesRecordsUpdationModalComponent implements OnInit {
    ...
    private _component!: DissagregationsSchemesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Dissagregations Schemes Records updation component
     */
    @ViewChild(DissagregationsSchemesRecordsUpdationComponent)
    public set component(component: DissagregationsSchemesRecordsUpdationComponent) {
     ...
     * the Dissagregations Schemes Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Dissagregations Schemes Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Dissagregations Schemes Records updation component`);
