...
import { DissagregationsSchemesRecordsDeletionComponent } from '../../components/dissagregations-schemes-records-deletion/dissagregations-schemes-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Dissagregations Schemes Records Deletion Modal]";

@Component({
    selector: 'sb-dissagregationsSchemes-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-schemes-records-deletion-modal.component.html',
    styleUrls: ['dissagregations-schemes-records-deletion-modal.component.scss'],
})
export class DissagregationsSchemesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Dissagregation Scheme record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Options Type Record";    

    // Keeps a reference to the Dissagregations Schemes Records creation component
    private _component!: DissagregationsSchemesRecordsDeletionComponent;
    ...
    constructor(
        public activeDissagregationsSchemesModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Dissagregations Schemes Records deletion component
     */
    @ViewChild(DissagregationsSchemesRecordsDeletionComponent)
    public set component(component: DissagregationsSchemesRecordsDeletionComponent) {
     ...
     * the Dissagregations Schemes Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Dissagregations Schemes Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Dissagregations Schemes Records deleting component`);
    ...
    onSucceeded() {
        ...
        timer(1000).subscribe(x => {
            ...
            this.activeDissagregationsSchemesModal.close();
