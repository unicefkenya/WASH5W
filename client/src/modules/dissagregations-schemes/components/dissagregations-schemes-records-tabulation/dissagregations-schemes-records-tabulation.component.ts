...
import { DissagregationsSchemesRecordsCreationModalComponent } from '@modules/dissagregations-schemes/containers/dissagregations-schemes-records-creation-modal/dissagregations-schemes-records-creation-modal.component';
import { DissagregationsSchemesRecordsDeletionModalComponent } from '@modules/dissagregations-schemes/containers/dissagregations-schemes-records-deletion-modal/dissagregations-schemes-records-deletion-modal.component';
import { DissagregationsSchemesRecordsUpdationModalComponent } from '@modules/dissagregations-schemes/containers/dissagregations-schemes-records-updation-modal/dissagregations-schemes-records-updation-modal.component';
...
const LOG_PREFIX: string = "[Dissagregations Schemes Records Tabulation Component]";

@Component({
    selector: 'sb-dissagregationsSchemes-records-tabulation',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './dissagregations-schemes-records-tabulation.component.html',
    styleUrls: ['dissagregations-schemes-records-tabulation.component.scss'],
})
export class DissagregationsSchemesRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        public dissagregationsSchemesDataService: DissagregationsSchemesDataService,
    ...
    /**
     * Handles Dissagregations Schemes Records Addition Requests
     */
    public onAddDissagregationScheme(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddDissagregationScheme()`);

        this.modalService.open(DissagregationsSchemesRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Dissagregations Schemes Records Updation Requests
     */
    public onUpdateDissagregationScheme(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateDissagregationScheme()`);
        this.log.debug(`${LOG_PREFIX} Dissagregation Scheme Id = ${id}`);

        const modalRef = this.modalService.open(DissagregationsSchemesRecordsUpdationModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;

    }

    /**
     * Handles Dissagregations Schemes Records Deletion Requests
     */
    public onDeleteDissagregationScheme(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteDissagregationScheme()`);
        this.log.debug(`${LOG_PREFIX} Dissagregation Scheme Id = ${id}`);

        const modalRef = this.modalService.open(DissagregationsSchemesRecordsDeletionModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;
    }
