...
import { IndicatorsRecordsDeletionComponent } from '../../components/indicators-records-deletion/indicators-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Indicators Records Deletion Modal]";

@Component({
    selector: 'sb-indicators-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './indicators-records-deletion-modal.component.html',
    styleUrls: ['indicators-records-deletion-modal.component.scss'],
})
export class IndicatorsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Indicator record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Indicator Record";    

    // Keeps a reference to the Indicators Records creation component
    private _component!: IndicatorsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Indicators Records deletion component
     */
    @ViewChild(IndicatorsRecordsDeletionComponent)
    public set component(component: IndicatorsRecordsDeletionComponent) {
     ...
     * the Indicators Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Indicators Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Indicators Records deleting component`);
