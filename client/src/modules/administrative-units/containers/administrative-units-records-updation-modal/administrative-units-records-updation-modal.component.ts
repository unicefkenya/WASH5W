...
import { AdministrativeUnitsRecordsUpdationComponent } from '../../components/administrative-units-records-updation/administrative-units-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Administrative Units Records Updation Modal]";

@Component({
    selector: 'sb-administrative-units-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-records-updation-modal.component.html',
    styleUrls: ['administrative-units-records-updation-modal.component.scss'],
})
export class AdministrativeUnitsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative Unit record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Administrative Unit Record";    

    // Keeps a reference to the Administrative Units Records creation component
    private _component!: AdministrativeUnitsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Units Records updation component
     */
    @ViewChild(AdministrativeUnitsRecordsUpdationComponent)
    public set component(component: AdministrativeUnitsRecordsUpdationComponent) {
     ...
     * the Administrative Units Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Units Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Units Records updation component`);
