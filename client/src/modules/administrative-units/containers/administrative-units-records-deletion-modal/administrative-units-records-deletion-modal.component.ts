...
import { AdministrativeUnitsRecordsDeletionComponent } from '../../components/administrative-units-records-deletion/administrative-units-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Units Records Deletion Modal]";

@Component({
    selector: 'sb-administrative-units-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-records-deletion-modal.component.html',
    styleUrls: ['administrative-units-records-deletion-modal.component.scss'],
})
export class AdministrativeUnitsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative Unit record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Administrative Unit Record";    

    // Keeps a reference to the Administrative Units Records creation component
    private _component!: AdministrativeUnitsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Units Records deletion component
     */
    @ViewChild(AdministrativeUnitsRecordsDeletionComponent)
    public set component(component: AdministrativeUnitsRecordsDeletionComponent) {
     ...
     * the Administrative Units Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Administrative Units Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Units Records deleting component`);
