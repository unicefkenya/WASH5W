...
import { AdministrativeUnitsRecordsCreationComponent } from '../../components/administrative-units-records-creation/administrative-units-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Units Records Creation Modal]";

@Component({
    selector: 'sb-administrative-units-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-units-records-creation-modal.component.html',
    styleUrls: ['administrative-units-records-creation-modal.component.scss'],
})
export class AdministrativeUnitsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Allows the parent component to inject the unique identifier of the parent Context record
    @Input() public typeId!: number;

    // Keeps tab of the page title
    public title: string = "Create Administrative Unit Record";

    // Keeps a reference to the Administrative Units Records creation component
    private _component!: AdministrativeUnitsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Units Records creation component
     */
    @ViewChild(AdministrativeUnitsRecordsCreationComponent)
    public set component(component: AdministrativeUnitsRecordsCreationComponent) {
     ...
     * the Administrative Units Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Units Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Units Records creation component`);
