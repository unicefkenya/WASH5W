...
import { WorkflowsRecordsDeletionComponent } from '../../components/workflows-records-deletion/workflows-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Workflows Records Deletion Modal]";

@Component({
    selector: 'sb-workflows-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './workflows-records-deletion-modal.component.html',
    styleUrls: ['workflows-records-deletion-modal.component.scss'],
})
export class WorkflowsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Workflow record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Workflow Record";    

    // Keeps a reference to the Workflows Records creation component
    private _component!: WorkflowsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Workflows Records deletion component
     */
    @ViewChild(WorkflowsRecordsDeletionComponent)
    public set component(component: WorkflowsRecordsDeletionComponent) {
     ...
     * the Workflows Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Workflows Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Workflows Records deleting component`);
