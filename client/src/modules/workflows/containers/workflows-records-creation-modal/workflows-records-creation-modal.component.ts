...
import { WorkflowsRecordsCreationComponent } from '../../components/workflows-records-creation/workflows-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Workflows Records Creation Modal]";

@Component({
    selector: 'sb-workflows-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './workflows-records-creation-modal.component.html',
    styleUrls: ['workflows-records-creation-modal.component.scss'],
})
export class WorkflowsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Workflow Record";

    // Keeps a reference to the Workflows Records creation component
    private _component!: WorkflowsRecordsCreationComponent;
    ...
    constructor(
        public activeWorkflowsModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Workflows Records creation component
     */
    @ViewChild(WorkflowsRecordsCreationComponent)
    public set component(component: WorkflowsRecordsCreationComponent) {
     ...
     * the Workflows Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Workflows Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Workflows Records creation component`);
