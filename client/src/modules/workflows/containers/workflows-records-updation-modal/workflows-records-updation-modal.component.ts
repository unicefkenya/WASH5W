...
import { WorkflowsRecordsUpdationComponent } from '../../components/workflows-records-updation/workflows-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Workflows Records Updation Modal]";

@Component({
    selector: 'sb-workflows-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './workflows-records-updation-modal.component.html',
    styleUrls: ['workflows-records-updation-modal.component.scss'],
})
export class WorkflowsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Workflow record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Workflow Record";    

    // Keeps a reference to the Workflows Records creation component
    private _component!: WorkflowsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Workflows Records updation component
     */
    @ViewChild(WorkflowsRecordsUpdationComponent)
    public set component(component: WorkflowsRecordsUpdationComponent) {
     ...
     * the Workflows Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Workflows Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Workflows Records updation component`);
