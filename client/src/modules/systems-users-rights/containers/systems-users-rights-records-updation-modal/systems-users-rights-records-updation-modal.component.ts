...
import { SystemsUsersRightsRecordsUpdationComponent } from '../../components/systems-users-rights-records-updation/systems-users-rights-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Systems Users Rights Records Updation Modal]";

@Component({
    selector: 'sb-systems-users-rights-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-users-rights-records-updation-modal.component.html',
    styleUrls: ['systems-users-rights-records-updation-modal.component.scss'],
})
export class SystemsUsersRightsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System User Right record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update System User Right Record";

    // Keeps a reference to the Systems Users Rights Records creation component
    private _component!: SystemsUsersRightsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed SystemsUsersRights Records updation component
     */
    @ViewChild(SystemsUsersRightsRecordsUpdationComponent)
    public set component(component: SystemsUsersRightsRecordsUpdationComponent) {
     ...
     * the SystemsUsersRights Records updation component
     */
    onSave() {
        ...
        // Call the save function in the SystemsUsersRights Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the SystemsUsersRights Records updation component`);
    ...
    public closeLocationSelector(): void {
        ...
        // Call the closeLocationSelector function in the SystemsUsersRights Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the closeLocationSelector function in the SystemsUsersRights Records creation component`);
