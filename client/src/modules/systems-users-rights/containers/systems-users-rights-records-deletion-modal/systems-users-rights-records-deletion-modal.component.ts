...
import { SystemsUsersRightsRecordsDeletionComponent } from '../../components/systems-users-rights-records-deletion/systems-users-rights-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Systems Users Rights Records Deletion Modal]";

@Component({
    selector: 'sb-systems-users-rights-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-users-rights-records-deletion-modal.component.html',
    styleUrls: ['systems-users-rights-records-deletion-modal.component.scss'],
})
export class SystemsUsersRightsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System User Right record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete System User Right Record";    

    // Keeps a reference to the Systems Users Rights Records creation component
    private _component!: SystemsUsersRightsRecordsDeletionComponent;
    ...
    constructor(
        public activeSystemsUsersRightsModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Systems Users Rights Records deletion component
     */
    @ViewChild(SystemsUsersRightsRecordsDeletionComponent)
    public set component(component: SystemsUsersRightsRecordsDeletionComponent) {
     ...
     * the Systems Users Rights Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Systems Users Rights Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Users Rights Records deleting component`);
    ...
    onSucceeded() {
        ...
        timer(1000).subscribe(x => {
            ...
            this.activeSystemsUsersRightsModal.close();
