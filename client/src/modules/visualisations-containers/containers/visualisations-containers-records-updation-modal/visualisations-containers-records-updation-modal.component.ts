...
import { VisualisationsContainersRecordsUpdationComponent } from '../../components/visualisations-containers-records-updation/visualisations-containers-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Visualisations Containers Records Updation Modal]";

@Component({
    selector: 'sb-visualisationsContainers-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisations-containers-records-updation-modal.component.html',
    styleUrls: ['visualisations-containers-records-updation-modal.component.scss'],
})
export class VisualisationsContainersRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation Container record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Visualisation Container Record";    

    // Keeps a reference to the Visualisations Containers Records creation component
    private _component!: VisualisationsContainersRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisations Containers Records updation component
     */
    @ViewChild(VisualisationsContainersRecordsUpdationComponent)
    public set component(component: VisualisationsContainersRecordsUpdationComponent) {
     ...
     * the Visualisations Containers Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisations Containers Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisations Containers Records updation component`);
