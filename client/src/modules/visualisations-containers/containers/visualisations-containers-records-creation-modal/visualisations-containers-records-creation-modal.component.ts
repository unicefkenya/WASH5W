...
import { VisualisationsContainersRecordsCreationComponent } from '../../components/visualisations-containers-records-creation/visualisations-containers-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Visualisations Containers Records Creation Modal]";

@Component({
    selector: 'sb-visualisationsContainers-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisations-containers-records-creation-modal.component.html',
    styleUrls: ['visualisations-containers-records-creation-modal.component.scss'],
})
export class VisualisationsContainersRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    public title: string = "Create Visualisation Container Record";

    // Keeps a reference to the Visualisations Containers Records creation component
    private _component!: VisualisationsContainersRecordsCreationComponent;
    ...
    constructor(
        public activeVisualisationsContainersModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Visualisations Containers Records creation component
     */
    @ViewChild(VisualisationsContainersRecordsCreationComponent)
    public set component(component: VisualisationsContainersRecordsCreationComponent) {
     ...
     * the Visualisations Containers Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisations Containers Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisations Containers Records creation component`);
    ...
    onQuit() {
        ...
        this.activeVisualisationsContainersModal.close();
    }
