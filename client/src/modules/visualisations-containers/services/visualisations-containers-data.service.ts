...
const LOG_PREFIX: string = "[Visualisations Containers Data Service]";
const HEADERS = { 'Content-Type': 'application/json' };

@Injectable({
  providedIn: 'root'
})
export class VisualisationsContainersDataService {
   ...
   * 
   * @param visualisationContainer the details of the Data Form Element Record to be created
   * @returns the newly created Data Form Element Record
   */
  public createVisualisationContainer(visualisationContainer: VisualisationContainer): Observable<VisualisationContainer> {

    this.log.trace(`${LOG_PREFIX} Entering createVisualisationContainer()`);
    this.log.debug(`${LOG_PREFIX} Data Form = ${JSON.stringify(visualisationContainer)}`);
    ...
    return this.http.post<VisualisationContainer>(`${this.url}`, JSON.stringify(visualisationContainer), { headers: new HttpHeaders(HEADERS) })
      .pipe(

        tap((data: VisualisationContainer) => {
          ...
          this.getFreshVisualisationsContainers(true, this.state).subscribe();
   ...
   * 
   * @param visualisationContainer The details of the Data Form Element Record to be updated
   * @returns the updated Data Form Element Record
   */
  public updateVisualisationContainer(visualisationContainer: VisualisationContainer): Observable<VisualisationContainer> {

    this.log.trace(`${LOG_PREFIX} Entering updateVisualisationContainer()`);
    this.log.debug(`${LOG_PREFIX} Data Form = ${JSON.stringify(visualisationContainer)}`);
    ...
    this.log.debug(`${LOG_PREFIX} Making a HTTP POST Request to ${this.url}/${visualisationContainer.id} to update the record`);
    return this.http.put<VisualisationContainer>(`${this.url}/${visualisationContainer.id} `, JSON.stringify(visualisationContainer), { headers: new HttpHeaders(HEADERS) })
      .pipe(
   ...
   *
   * @param visualisationContainerId The id of the Data Form Element Record to be deleted
   */
  public deleteVisualisationContainer(visualisationContainerId: number): Observable<void> {

    this.log.trace(`${LOG_PREFIX} Entering deleteVisualisationContainer()`);
    this.log.debug(`${LOG_PREFIX} Data Form Id = ${visualisationContainerId}`);

    // Make a HTTP DELETE Request to delete the records
    this.log.debug(`${LOG_PREFIX} Making a HTTP DELETE Request to ${this.url}/${visualisationContainerId} to delete the record`);

    return this.http.delete<void>(`${this.url}/${visualisationContainerId}`, { headers: new HttpHeaders(HEADERS) })
      .pipe(
