...
import { LogicalSchemesRecordsDeletionComponent } from '../../components/logical-schemes-records-deletion/logical-schemes-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Logical Schemes Records Deletion Modal]";

@Component({
    selector: 'sb-logical-schemes-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-schemes-records-deletion-modal.component.html',
    styleUrls: ['logical-schemes-records-deletion-modal.component.scss'],
})
export class LogicalSchemesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Scheme record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Logical Scheme Record";    

    // Keeps a reference to the Logical Schemes Records creation component
    private _component!: LogicalSchemesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Schemes Records deletion component
     */
    @ViewChild(LogicalSchemesRecordsDeletionComponent)
    public set component(component: LogicalSchemesRecordsDeletionComponent) {
     ...
     * the Logical Schemes Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Logical Schemes Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Schemes Records deleting component`);
