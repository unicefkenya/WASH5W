...
import { LogicalSchemesRecordsUpdationComponent } from '../../components/logical-schemes-records-updation/logical-schemes-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Logical Schemes Records Updation Modal]";

@Component({
    selector: 'sb-logical-schemes-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-schemes-records-updation-modal.component.html',
    styleUrls: ['logical-schemes-records-updation-modal.component.scss'],
})
export class LogicalSchemesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Logical Scheme record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Logical Scheme Record";    

    // Keeps a reference to the Logical Schemes Records creation component
    private _component!: LogicalSchemesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Logical Schemes Records updation component
     */
    @ViewChild(LogicalSchemesRecordsUpdationComponent)
    public set component(component: LogicalSchemesRecordsUpdationComponent) {
     ...
     * the Logical Schemes Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Logical Schemes Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Logical Schemes Records updation component`);
