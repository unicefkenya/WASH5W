...
import { LogicalSchemesRecordsCreationModalComponent } from '@modules/logical-schemes/containers/logical-schemes-records-creation-modal/logical-schemes-records-creation-modal.component';
import { LogicalSchemesRecordsDeletionModalComponent } from '@modules/logical-schemes/containers/logical-schemes-records-deletion-modal/logical-schemes-records-deletion-modal.component';
import { LogicalSchemesRecordsUpdationModalComponent } from '@modules/logical-schemes/containers/logical-schemes-records-updation-modal/logical-schemes-records-updation-modal.component';
...
const LOG_PREFIX: string = "[Logical Schemes Records Tabulation Component]";

@Component({
    selector: 'sb-logical-schemes-records-tabulation',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './logical-schemes-records-tabulation.component.html',
    styleUrls: ['logical-schemes-records-tabulation.component.scss'],
})
export class LogicalSchemesRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    /**
     * Handles Logical Schemes Records Addition Requests
     */
    public onAddLogicalScheme(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddLogicalScheme()`);

        this.modalService.open(LogicalSchemesRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Logical Schemes Records Updation Requests
     */
    public onUpdateLogicalScheme(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateLogicalScheme()`);
        this.log.debug(`${LOG_PREFIX} Logical Scheme Id = ${id}`);

        const modalRef = this.modalService.open(LogicalSchemesRecordsUpdationModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;

    }

    /**
     * Handles Logical Schemes Records Deletion Requests
     */
    public onDeleteLogicalScheme(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteLogicalScheme()`);
        this.log.debug(`${LOG_PREFIX} Logical Scheme Id = ${id}`);

        const modalRef = this.modalService.open(LogicalSchemesRecordsDeletionModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;
    }
