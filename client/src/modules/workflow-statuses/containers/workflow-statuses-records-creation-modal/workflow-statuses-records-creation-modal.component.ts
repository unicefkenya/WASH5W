...
import { WorkflowStatusesRecordsCreationComponent } from '../../components/workflow-statuses-records-creation/workflow-statuses-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Workflow Statuses Records Creation Modal]";

@Component({
    selector: 'sb-workflow-statuses-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './workflow-statuses-records-creation-modal.component.html',
    styleUrls: ['workflow-statuses-records-creation-modal.component.scss'],
})
export class WorkflowStatusesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Workflow Status Record";

    // Keeps a reference to the Workflow Statuses Records creation component
    private _component!: WorkflowStatusesRecordsCreationComponent;
    ...
    constructor(
        public activeWorkflowStatusesModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Workflow Statuses Records creation component
     */
    @ViewChild(WorkflowStatusesRecordsCreationComponent)
    public set component(component: WorkflowStatusesRecordsCreationComponent) {
     ...
     * the Workflow Statuses Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Workflow Statuses Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Workflow Statuses Records creation component`);
    ...
    onQuit() {
        ...
        this.activeWorkflowStatusesModal.close();
    }
