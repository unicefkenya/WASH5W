...
import { WorkflowStatusesRecordsDeletionComponent } from '../../components/workflow-statuses-records-deletion/workflow-statuses-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Workflow Statuses Records Deletion Modal]";

@Component({
    selector: 'sb-workflow-statuses-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './workflow-statuses-records-deletion-modal.component.html',
    styleUrls: ['workflow-statuses-records-deletion-modal.component.scss'],
})
export class WorkflowStatusesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Workflow Status record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Workflow Status Record";    

    // Keeps a reference to the Workflow Statuses Records creation component
    private _component!: WorkflowStatusesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Workflow Statuses Records deletion component
     */
    @ViewChild(WorkflowStatusesRecordsDeletionComponent)
    public set component(component: WorkflowStatusesRecordsDeletionComponent) {
     ...
     * the Workflow Statuses Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Workflow Statuses Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Workflow Statuses Records deleting component`);
