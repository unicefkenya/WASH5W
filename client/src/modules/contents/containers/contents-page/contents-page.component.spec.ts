...
@Component({
    template: `
        <sb-contents-page [someInput]="someInput" (someFunction)="someFunction($event)"></sb-contents-page>
    `,
})
...
describe('ContentsPageComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, ContentsPageComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sb-contents-page')).toEqual(jasmine.anything());
    });
});
