...
import { OrganisationsRecordsUpdationComponent } from '../../components/organisations-records-updation/organisations-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Organisations Records Updation Modal]";

@Component({
    selector: 'sb-organisations-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './organisations-records-updation-modal.component.html',
    styleUrls: ['organisations-records-updation-modal.component.scss'],
})
export class OrganisationsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Organisation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Organisation Record";    

    // Keeps a reference to the Organisations Records creation component
    private _component!: OrganisationsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Organisations Records updation component
     */
    @ViewChild(OrganisationsRecordsUpdationComponent)
    public set component(component: OrganisationsRecordsUpdationComponent) {
     ...
     * the Organisations Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Organisations Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Organisations Records updation component`);
