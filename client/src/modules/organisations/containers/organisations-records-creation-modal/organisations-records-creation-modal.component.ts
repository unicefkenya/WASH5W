...
import { OrganisationsRecordsCreationComponent } from '../../components/organisations-records-creation/organisations-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Organisations Records Creation Modal]";

@Component({
    selector: 'sb-organisations-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './organisations-records-creation-modal.component.html',
    styleUrls: ['organisations-records-creation-modal.component.scss'],
})
export class OrganisationsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Allows the parent component to inject the unique identifier of the parent Context record
    @Input() public typeId!: number;

    // Keeps tab of the page title
    public title: string = "Create Organisation Record";

    // Keeps a reference to the Organisations Records creation component
    private _component!: OrganisationsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Organisations Records creation component
     */
    @ViewChild(OrganisationsRecordsCreationComponent)
    public set component(component: OrganisationsRecordsCreationComponent) {
     ...
     * the Organisations Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Organisations Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Organisations Records creation component`);
