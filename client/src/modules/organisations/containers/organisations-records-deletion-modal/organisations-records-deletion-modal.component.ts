...
import { OrganisationsRecordsDeletionComponent } from '../../components/organisations-records-deletion/organisations-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Organisations Records Deletion Modal]";

@Component({
    selector: 'sb-organisations-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './organisations-records-deletion-modal.component.html',
    styleUrls: ['organisations-records-deletion-modal.component.scss'],
})
export class OrganisationsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Organisation record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Organisation Record";    

    // Keeps a reference to the Organisations Records creation component
    private _component!: OrganisationsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Organisations Records deletion component
     */
    @ViewChild(OrganisationsRecordsDeletionComponent)
    public set component(component: OrganisationsRecordsDeletionComponent) {
     ...
     * the Organisations Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Organisations Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Organisations Records deleting component`);
