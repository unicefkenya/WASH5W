...
import { AdministrativeStructuresRecordsDeletionComponent } from '../../components/administrative-structures-records-deletion/administrative-structures-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Structures Records Deletion Modal]";

@Component({
    selector: 'sb-administrative-structures-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-structures-records-deletion-modal.component.html',
    styleUrls: ['administrative-structures-records-deletion-modal.component.scss'],
})
export class AdministrativeStructuresRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative Structure record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Administrative Structure Record";    

    // Keeps a reference to the Administrative Structures Records creation component
    private _component!: AdministrativeStructuresRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Structures Records deletion component
     */
    @ViewChild(AdministrativeStructuresRecordsDeletionComponent)
    public set component(component: AdministrativeStructuresRecordsDeletionComponent) {
     ...
     * the Administrative Structures Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Administrative Structures Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Structures Records deleting component`);
