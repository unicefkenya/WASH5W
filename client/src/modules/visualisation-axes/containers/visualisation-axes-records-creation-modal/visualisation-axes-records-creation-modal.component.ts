...
import { VisualisationAxesRecordsCreationComponent } from '../../components/visualisation-axes-records-creation/visualisation-axes-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Visualisation Axes Records Creation Modal]";

@Component({
    selector: 'sb-visualisation-axes-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisation-axes-records-creation-modal.component.html',
    styleUrls: ['visualisation-axes-records-creation-modal.component.scss'],
})
export class VisualisationAxesRecordsCreationModalComponent implements OnInit, OnDestroy {
  ...
  @Input() public visualisationId!: number;
    ...
    public title: string = "Create Visualisation Axis Record";

    // Keeps a reference to the Visualisation Axes Records creation component
    private _component!: VisualisationAxesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisation Axes Records creation component
     */
    @ViewChild(VisualisationAxesRecordsCreationComponent)
    public set component(component: VisualisationAxesRecordsCreationComponent) {
     ...
     * the Visualisation Axes Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisation Axes Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisation Axes Records creation component`);
