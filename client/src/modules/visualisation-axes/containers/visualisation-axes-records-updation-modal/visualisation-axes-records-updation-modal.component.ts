...
import { VisualisationAxesRecordsUpdationComponent } from '../../components/visualisation-axes-records-updation/visualisation-axes-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Visualisation Axes Records Updation Modal]";

@Component({
    selector: 'sb-visualisation-axes-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisation-axes-records-updation-modal.component.html',
    styleUrls: ['visualisation-axes-records-updation-modal.component.scss'],
})
export class VisualisationAxesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation Axis record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Visualisation Axis Record";    

    // Keeps a reference to the Visualisation Axes Records creation component
    private _component!: VisualisationAxesRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisation Axes Records updation component
     */
    @ViewChild(VisualisationAxesRecordsUpdationComponent)
    public set component(component: VisualisationAxesRecordsUpdationComponent) {
     ...
     * the Visualisation Axes Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Visualisation Axes Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisation Axes Records updation component`);
