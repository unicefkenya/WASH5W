...
import { VisualisationAxesRecordsDeletionComponent } from '../../components/visualisation-axes-records-deletion/visualisation-axes-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Visualisation Axes Records Deletion Modal]";

@Component({
    selector: 'sb-visualisation-axes-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './visualisation-axes-records-deletion-modal.component.html',
    styleUrls: ['visualisation-axes-records-deletion-modal.component.scss'],
})
export class VisualisationAxesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Visualisation Axis record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Visualisation Axis Record";    

    // Keeps a reference to the Visualisation Axes Records creation component
    private _component!: VisualisationAxesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Visualisation Axes Records deletion component
     */
    @ViewChild(VisualisationAxesRecordsDeletionComponent)
    public set component(component: VisualisationAxesRecordsDeletionComponent) {
     ...
     * the Visualisation Axes Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Visualisation Axes Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Visualisation Axes Records deleting component`);
