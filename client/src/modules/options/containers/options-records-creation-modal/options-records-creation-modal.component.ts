...
import { OptionsRecordsCreationComponent } from '../../components/options-records-creation/options-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';

const LOG_PREFIX: string = "[Options Records Creation Modal]";

@Component({
    selector: 'sb-options-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './options-records-creation-modal.component.html',
    styleUrls: ['options-records-creation-modal.component.scss'],
})
export class OptionsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Allows the parent component to inject the unique identifier of the parent Context record
    @Input() public typeId!: number;

    // Keeps tab of the page title
    public title: string = "Create Option Record";

    // Keeps a reference to the Options Records creation component
    private _component!: OptionsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Options Records creation component
     */
    @ViewChild(OptionsRecordsCreationComponent)
    public set component(component: OptionsRecordsCreationComponent) {
     ...
     * the Options Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Options Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Options Records creation component`);
