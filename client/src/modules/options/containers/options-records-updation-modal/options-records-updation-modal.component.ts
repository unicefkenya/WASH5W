...
import { OptionsRecordsUpdationComponent } from '../../components/options-records-updation/options-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Options Records Updation Modal]";

@Component({
    selector: 'sb-options-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './options-records-updation-modal.component.html',
    styleUrls: ['options-records-updation-modal.component.scss'],
})
export class OptionsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Option record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Option Record";    

    // Keeps a reference to the Options Records creation component
    private _component!: OptionsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Options Records updation component
     */
    @ViewChild(OptionsRecordsUpdationComponent)
    public set component(component: OptionsRecordsUpdationComponent) {
     ...
     * the Options Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Options Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Options Records updation component`);
