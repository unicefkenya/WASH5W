...
import { OptionsRecordsDeletionComponent } from '../../components/options-records-deletion/options-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Options Records Deletion Modal]";

@Component({
    selector: 'sb-options-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './options-records-deletion-modal.component.html',
    styleUrls: ['options-records-deletion-modal.component.scss'],
})
export class OptionsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Option record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Option Record";    

    // Keeps a reference to the Options Records creation component
    private _component!: OptionsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Options Records deletion component
     */
    @ViewChild(OptionsRecordsDeletionComponent)
    public set component(component: OptionsRecordsDeletionComponent) {
     ...
     * the Options Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Options Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Options Records deleting component`);
