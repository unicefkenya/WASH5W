...
import { SystemsModulesPermissionsRecordsUpdationComponent } from '../../components/systems-modules-permissions-records-updation/systems-modules-permissions-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Systems Modules Permissions Records Updation Modal]";

@Component({
    selector: 'sb-systems-modules-permissions-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-modules-permissions-records-updation-modal.component.html',
    styleUrls: ['systems-modules-permissions-records-updation-modal.component.scss'],
})
export class SystemsModulesPermissionsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Module Permission record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update System Module Permission Record";    

    // Keeps a reference to the Systems Modules Permissions Records creation component
    private _component!: SystemsModulesPermissionsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Modules Permissions Records updation component
     */
    @ViewChild(SystemsModulesPermissionsRecordsUpdationComponent)
    public set component(component: SystemsModulesPermissionsRecordsUpdationComponent) {
     ...
     * the Systems Modules Permissions Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Modules Permissions Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Modules Permissions Records updation component`);
