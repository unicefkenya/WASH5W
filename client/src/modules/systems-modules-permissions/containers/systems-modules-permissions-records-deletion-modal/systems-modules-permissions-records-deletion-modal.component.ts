...
import { SystemsModulesPermissionsRecordsDeletionComponent } from '../../components/systems-modules-permissions-records-deletion/systems-modules-permissions-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Systems Modules Permissions Records Deletion Modal]";

@Component({
    selector: 'sb-systems-modules-permissions-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-modules-permissions-records-deletion-modal.component.html',
    styleUrls: ['systems-modules-permissions-records-deletion-modal.component.scss'],
})
export class SystemsModulesPermissionsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Module Permission record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete System Module Permission Record";    

    // Keeps a reference to the Systems Modules Permissions Records creation component
    private _component!: SystemsModulesPermissionsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Modules Permissions Records deletion component
     */
    @ViewChild(SystemsModulesPermissionsRecordsDeletionComponent)
    public set component(component: SystemsModulesPermissionsRecordsDeletionComponent) {
     ...
     * the Systems Modules Permissions Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Systems Modules Permissions Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Modules Permissions Records deleting component`);
