...
import { OrganisationsDataFormsResponsesRecordsCreationComponent } from '../../components/organisations-data-forms-responses-records-creation/organisations-data-forms-responses-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject } from 'rxjs';
import { Organisation } from '@modules/organisations/models/organisation.model';

const LOG_PREFIX: string = "[Organisations Data Forms Responses Records Creation Modal]";

@Component({
    selector: 'sb-organisations-data-forms-responses-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './organisations-data-forms-responses-records-creation-modal.component.html',
    styleUrls: ['organisations-data-forms-responses-records-creation-modal.component.scss'],
})
export class OrganisationsDataFormsResponsesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Allow the parent component to pass in the target organisation
    @Input() public organisation!: Organisation;

    // Keeps tab of the page title
    public title: string = "Create Organisation Data Form Response Record";

    // Keeps a reference to the Organisations Data Forms Responses Records creation component
    private _component!: OrganisationsDataFormsResponsesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Organisations Data Forms Responses Records creation component
     */
    @ViewChild(OrganisationsDataFormsResponsesRecordsCreationComponent)
    public set component(component: OrganisationsDataFormsResponsesRecordsCreationComponent) {
