...
import { SystemsRolesRecordsUpdationComponent } from '../../components/systems-roles-records-updation/systems-roles-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Systems Roles Records Updation Modal]";

@Component({
    selector: 'sb-systemsRoles-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-roles-records-updation-modal.component.html',
    styleUrls: ['systems-roles-records-updation-modal.component.scss'],
})
export class SystemsRolesRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Role record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update System Role Record";    

    // Keeps a reference to the Systems Roles Records creation component
    private _component!: SystemsRolesRecordsUpdationComponent;
    ...
    constructor(
        public activeSystemsRolesModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Systems Roles Records updation component
     */
    @ViewChild(SystemsRolesRecordsUpdationComponent)
    public set component(component: SystemsRolesRecordsUpdationComponent) {
     ...
     * the Systems Roles Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Roles Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Roles Records updation component`);
    ...
    onSucceeded() {
        ...
        timer(1000).subscribe(x => {
            ...
            this.activeSystemsRolesModal.close();
