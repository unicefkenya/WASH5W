...
import { SystemsRolesRecordsCreationComponent } from '../../components/systems-roles-records-creation/systems-roles-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Systems Roles Records Creation Modal]";

@Component({
    selector: 'sb-systemsRoles-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-roles-records-creation-modal.component.html',
    styleUrls: ['systems-roles-records-creation-modal.component.scss'],
})
export class SystemsRolesRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create System Role Record";

    // Keeps a reference to the Systems Roles Records creation component
    private _component!: SystemsRolesRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Roles Records creation component
     */
    @ViewChild(SystemsRolesRecordsCreationComponent)
    public set component(component: SystemsRolesRecordsCreationComponent) {
     ...
     * the Systems Roles Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Roles Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Roles Records creation component`);
