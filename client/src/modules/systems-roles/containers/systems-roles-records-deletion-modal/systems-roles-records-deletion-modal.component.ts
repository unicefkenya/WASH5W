...
import { SystemsRolesRecordsDeletionComponent } from '../../components/systems-roles-records-deletion/systems-roles-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Systems Roles Records Deletion Modal]";

@Component({
    selector: 'sb-systemsRoles-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-roles-records-deletion-modal.component.html',
    styleUrls: ['systems-roles-records-deletion-modal.component.scss'],
})
export class SystemsRolesRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System Role record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete System Role Record";    

    // Keeps a reference to the Systems Roles Records creation component
    private _component!: SystemsRolesRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Roles Records deletion component
     */
    @ViewChild(SystemsRolesRecordsDeletionComponent)
    public set component(component: SystemsRolesRecordsDeletionComponent) {
     ...
     * the Systems Roles Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Systems Roles Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Roles Records deleting component`);
