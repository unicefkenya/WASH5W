...
import { AdministrativeSystemsRecordsCreationModalComponent } from '@modules/administrative-systems/containers/administrative-systems-records-creation-modal/administrative-systems-records-creation-modal.component';
import { AdministrativeSystemsRecordsDeletionModalComponent } from '@modules/administrative-systems/containers/administrative-systems-records-deletion-modal/administrative-systems-records-deletion-modal.component';
import { AdministrativeSystemsRecordsUpdationModalComponent } from '@modules/administrative-systems/containers/administrative-systems-records-updation-modal/administrative-systems-records-updation-modal.component';
...
const LOG_PREFIX: string = "[Administrative Systems Records Tabulation Component]";

@Component({
    selector: 'sb-administrative-systems-records-tabulation',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-systems-records-tabulation.component.html',
    styleUrls: ['administrative-systems-records-tabulation.component.scss'],
})
export class AdministrativeSystemsRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    /**
     * Handles Administrative Systems Records Addition Requests
     */
    public onAddAdministrativeSystem(): void {

        this.log.trace(`${LOG_PREFIX} Entering onAddAdministrativeSystem()`);

        this.modalService.open(AdministrativeSystemsRecordsCreationModalComponent, { centered: true, backdrop: 'static' });
    }

    /**
     * Handles Administrative Systems Records Updation Requests
     */
    public onUpdateAdministrativeSystem(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onUpdateAdministrativeSystem()`);
        this.log.debug(`${LOG_PREFIX} Administrative System Id = ${id}`);

        const modalRef = this.modalService.open(AdministrativeSystemsRecordsUpdationModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;

    }

    /**
     * Handles Administrative Systems Records Deletion Requests
     */
    public onDeleteAdministrativeSystem(id: number): void {

        this.log.trace(`${LOG_PREFIX} Entering onDeleteAdministrativeSystem()`);
        this.log.debug(`${LOG_PREFIX} Administrative System Id = ${id}`);

        const modalRef = this.modalService.open(AdministrativeSystemsRecordsDeletionModalComponent, { centered: true, backdrop: 'static' });
        modalRef.componentInstance.id = id;
    }
