...
import { AdministrativeSystemsRecordsCreationComponent } from '../../components/administrative-systems-records-creation/administrative-systems-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Administrative Systems Records Creation Modal]";

@Component({
    selector: 'sb-administrative-systems-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-systems-records-creation-modal.component.html',
    styleUrls: ['administrative-systems-records-creation-modal.component.scss'],
})
export class AdministrativeSystemsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Administrative System Record";

    // Keeps a reference to the Administrative Systems Records creation component
    private _component!: AdministrativeSystemsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Systems Records creation component
     */
    @ViewChild(AdministrativeSystemsRecordsCreationComponent)
    public set component(component: AdministrativeSystemsRecordsCreationComponent) {
     ...
     * the Administrative Systems Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Systems Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Systems Records creation component`);
