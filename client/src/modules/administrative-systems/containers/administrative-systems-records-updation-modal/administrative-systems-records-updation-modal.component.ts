...
import { AdministrativeSystemsRecordsUpdationComponent } from '../../components/administrative-systems-records-updation/administrative-systems-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Administrative Systems Records Updation Modal]";

@Component({
    selector: 'sb-administrative-systems-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './administrative-systems-records-updation-modal.component.html',
    styleUrls: ['administrative-systems-records-updation-modal.component.scss'],
})
export class AdministrativeSystemsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Administrative System record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Administrative System Record";    

    // Keeps a reference to the Administrative Systems Records creation component
    private _component!: AdministrativeSystemsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Administrative Systems Records updation component
     */
    @ViewChild(AdministrativeSystemsRecordsUpdationComponent)
    public set component(component: AdministrativeSystemsRecordsUpdationComponent) {
     ...
     * the Administrative Systems Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Administrative Systems Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Administrative Systems Records updation component`);
