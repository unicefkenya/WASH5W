...
import { ContextsRecordsUpdationComponent } from '../../components/contexts-records-updation/contexts-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Contexts Records Updation Modal]";

@Component({
    selector: 'sb-contexts-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './contexts-records-updation-modal.component.html',
    styleUrls: ['contexts-records-updation-modal.component.scss'],
})
export class ContextsRecordsUpdationModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Context record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Update Context Record";    

    // Keeps a reference to the Contexts Records creation component
    private _component!: ContextsRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Contexts Records updation component
     */
    @ViewChild(ContextsRecordsUpdationComponent)
    public set component(component: ContextsRecordsUpdationComponent) {
     ...
     * the Contexts Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Contexts Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Contexts Records updation component`);
