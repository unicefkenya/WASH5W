...
import { ContextsRecordsDeletionComponent } from '../../components/contexts-records-deletion/contexts-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Contexts Records Deletion Modal]";

@Component({
    selector: 'sb-contexts-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './contexts-records-deletion-modal.component.html',
    styleUrls: ['contexts-records-deletion-modal.component.scss'],
})
export class ContextsRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target Context record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete Context Record";    

    // Keeps a reference to the Contexts Records creation component
    private _component!: ContextsRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Contexts Records deletion component
     */
    @ViewChild(ContextsRecordsDeletionComponent)
    public set component(component: ContextsRecordsDeletionComponent) {
     ...
     * the Contexts Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Contexts Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Contexts Records deleting component`);
