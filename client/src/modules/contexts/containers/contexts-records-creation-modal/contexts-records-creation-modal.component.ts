...
import { ContextsRecordsCreationComponent } from '../../components/contexts-records-creation/contexts-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Contexts Records Creation Modal]";

@Component({
    selector: 'sb-contexts-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './contexts-records-creation-modal.component.html',
    styleUrls: ['contexts-records-creation-modal.component.scss'],
})
export class ContextsRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Keeps tab of the page title
    public title: string = "Create Context Record";

    // Keeps a reference to the Contexts Records creation component
    private _component!: ContextsRecordsCreationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Contexts Records creation component
     */
    @ViewChild(ContextsRecordsCreationComponent)
    public set component(component: ContextsRecordsCreationComponent) {
     ...
     * the Contexts Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Contexts Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Contexts Records creation component`);
