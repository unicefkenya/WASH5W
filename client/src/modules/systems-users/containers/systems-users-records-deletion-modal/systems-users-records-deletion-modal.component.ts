...
import { SystemsUsersRecordsDeletionComponent } from '../../components/systems-users-records-deletion/systems-users-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';

const LOG_PREFIX: string = "[Systems Users Records Deletion Modal]";

@Component({
    selector: 'sb-systemsUsers-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-users-records-deletion-modal.component.html',
    styleUrls: ['systems-users-records-deletion-modal.component.scss'],
})
export class SystemsUsersRecordsDeletionModalComponent implements OnInit {

    // Allows the parent component to inject the unique identifier of the target System User record
    @Input() public id!: number;

    // Keeps tab of the page title
    public title: string = "Delete System User Record";    

    // Keeps a reference to the Systems Users Records creation component
    private _component!: SystemsUsersRecordsDeletionComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Users Records deletion component
     */
    @ViewChild(SystemsUsersRecordsDeletionComponent)
    public set component(component: SystemsUsersRecordsDeletionComponent) {
     ...
     * the Systems Users Records deletion component
     */
     onDelete() {
        ...
        // Call the save function in the Systems Users Records deleting component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Users Records deleting component`);
