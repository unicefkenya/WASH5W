...
import { SystemsUsersRecordsCreationComponent } from '../../components/systems-users-records-creation/systems-users-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Systems Users Records Creation Modal]";

@Component({
    selector: 'sb-systemsUsers-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-users-records-creation-modal.component.html',
    styleUrls: ['systems-users-records-creation-modal.component.scss'],
})
export class SystemsUsersRecordsCreationModalComponent implements OnInit, OnDestroy {

    // Allow the parent component to set the mode of operation (self or administered)
    @Input() mode: string = "self";

    // Keeps tab of the page title
    public title: string = "Create System User Record";

    // Keeps a reference to the Systems Users Records creation component
    private _component!: SystemsUsersRecordsCreationComponent;
    ...
    constructor(
        public activeSystemsUsersModal: NgbActiveModal,
    ...
    /**
     * Initialises the local reference to the displayed Systems Users Records creation component
     */
    @ViewChild(SystemsUsersRecordsCreationComponent)
    public set component(component: SystemsUsersRecordsCreationComponent) {
     ...
     * the Systems Users Records creation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Users Records creation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Users Records creation component`);
    ...
    onQuit() {
        ...
        this.activeSystemsUsersModal.close();
    }
