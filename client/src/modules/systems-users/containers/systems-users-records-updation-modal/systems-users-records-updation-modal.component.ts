...
import { SystemsUsersRecordsUpdationComponent } from '../../components/systems-users-records-updation/systems-users-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, timer } from 'rxjs';


const LOG_PREFIX: string = "[Systems Users Records Updation Modal]";

@Component({
    selector: 'sb-systemsUsers-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './systems-users-records-updation-modal.component.html',
    styleUrls: ['systems-users-records-updation-modal.component.scss'],
})
export class SystemsUsersRecordsUpdationModalComponent implements OnInit {
    ...
    public title: string = "Update System User Record";

    // Keeps a reference to the Systems Users Records creation component
    private _component!: SystemsUsersRecordsUpdationComponent;
    ...
    /**
     * Initialises the local reference to the displayed Systems Users Records updation component
     */
    @ViewChild(SystemsUsersRecordsUpdationComponent)
    public set component(component: SystemsUsersRecordsUpdationComponent) {
     ...
     * the Systems Users Records updation component
     */
    onSave() {
        ...
        // Call the save function in the Systems Users Records updation component
        this.log.trace(`${LOG_PREFIX} Calling the save function in the Systems Users Records updation component`);
